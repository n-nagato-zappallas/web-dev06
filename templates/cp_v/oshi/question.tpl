                  ...
                  <div class="section_bdy">
                    <div class="section_ftr">
                      <div class="section_hdr">
                        ...
                        <div id="frm_btn">
                          <div class="form_btn">
                            <a href="javascript:void(0);" class="btn q_btn" onclick="click_btn( 0, this );" id="btn1"/>結果を見る（有料）</a>
                          </div>
...
{if $isp == '11'}
                <div class="attention">
                  ...
                  <p>このサービスのお問い合わせは<a href="/inquiry/?cont_id=359" target="_359">こちら</a>をご覧ください。</p>
                </div>
{/if}
