...
{if $menu_person == '1'}
                    <h2><img src="{$img_path}/img/special/result/graph_group/section_title1.jpg" alt="{if $isp == '70'}6人の人気占い師が毎月の運勢を占う！　2020年あなたの運勢グラフ※{else}人気占い師が占う！　2020年あなたの運勢グラフ{/if}"></h2>
{else}
                    <h2><img src="{$img_path}/img/special/result/graph_group/section_title2.jpg" alt="{if $isp == '70'}6人の人気占い師が毎月の運勢を占う！　2020年二人の運勢グラフ※{else}人気占い師が占う！　2020年二人の運勢グラフ{/if}"></h2>
{/if}
