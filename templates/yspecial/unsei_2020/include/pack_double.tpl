...
{if $menu_design_cd == 99}
                <div class="text_img">
                  <img src="{$img_path}/img/special/pack_group/pack_text2.jpg" alt="運勢グラフ付きで二人の毎月の運勢もバッチリわかる！　豪華2020年恋運命特別鑑定　お得なパックはこちら">
                </div>
{/if}
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/pack_group/group2/section_title.jpg" alt="豪華お得二人の恋パック　二人の運勢グラフ付きで毎月の運勢もわかる！　人気占い師6人が二人の恋を応援鑑定　2020年恋愛成就の決定版{if $isp == '70'}　それぞれ買うより5,900円以上もお得！※{elseif $isp == '40'}　それぞれ買うより4,900円以上もお得！※{else}　それぞれ買うより6,000円（税別）もお得※{/if}"></h2>
...
{if !$result_flag || $result_flag && $menu_person == '1'}
                        <div><a href="{$uri_path}/input/{if $isp == '11'}nu20_004{else}nu20_004{/if}.html"><img src="{$img_path}/img/special/pack_group/group2/btn.png" alt="人気占い師6人による豪華恋成就鑑定　「2020年あの人との恋」全恋運命特別鑑定パック" class="swapImage"></a></div>
{if $isp == '70'}
...
{if $menu_design_cd == 99}
                        <p><input type="image" src="{$img_path}/img/special/pack_group/group2/btn.png" alt="人気占い師6人による豪華恋成就鑑定　「2020年あの人との恋」全恋運命特別鑑定パック" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/{if $isp == '11'}nu20_004{else}nu20_004{/if}.html"><img src="{$img_path}/img/special/pack_group/group2/btn.png" alt="人気占い師6人による豪華恋成就鑑定　「2020年あの人との恋」全恋運命特別鑑定パック" class="swapImage"></a></p>
{/if}
{if $isp == '70'}
                        <p class="price_info ttl_font">会員価格{literal}　<strong class="price_discount">{YJPRICE_5400}</strong>{/literal}&nbsp;/&nbsp;
                        通常価格{literal}　<strong class="price_discount">{YJPRICE_6000}</strong>{/literal}</p>
