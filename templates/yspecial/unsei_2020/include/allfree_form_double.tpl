              ...
              <div id="free_group2">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group/group2/section_title.jpg" alt="二人の恋無料鑑定　あの人との恋は叶う？　2020年、あなたとあの人の恋　無料でズバリ鑑定！"></h2>
                    <h2><img src="{$img_path}/img/special/free_group/group2/section_hdr.jpg" alt="あなたの情報を入力してください"></h2>
                                ...
                                <div class="menu_ftr">
                                  <div class="menu_hdr">
                                    <table class="input_tbl input_tbl_1" cellspacing="0">
                                      <tbody>
                                        <tr class="tr_name">
                                          <th><label for="name_last_self2">お名前</label></th>
                                          <td>
                                            <label for="name_last_self2">&nbsp;姓&nbsp;</label><input type="text" id="name_last_self2" name="name_last_self" size="8" maxlength="8" class="input_name">
                                        ...
                                        <tr class="tr_kana">
                                          <th><label for="kana_last_self2">よみがな</label></th>
                                          <td>
                                            <label for="kana_last_self2">せい</label><input type="text" id="kana_last_self2" name="kana_last_self" size="8" maxlength="8" class="input_name">
                                  ...
                                  <div class="input_other">
                                    <h3><img src="{$img_path}/img/special/free_group/group2/title2.jpg" alt="あの人の情報を入力してください"></h3>
                                    <table class="input_tbl input_tbl_1" cellspacing="0">
                                      <tbody>
                                        <tr class="tr_name">
                                          <th><label for="name_last_other2">お名前</label></th>
                                          <td>
                                            <label for="name_last_other2">&nbsp;姓&nbsp;</label><input type="text" id="name_last_other2" name="name_last_other" size="8" maxlength="8" class="input_name">
                                        ...
                                        <tr class="tr_kana">
                                          <th><label for="kana_last_other2">よみがな</label></th>
                                          <td>
                                            <label for="kana_last_other2">せい</label><input type="text" id="kana_last_other2" name="kana_last_other" size="8" maxlength="8" class="input_name">
                                    ...
                                    <div class="form_btn">
                                      <input type="image" src="{$img_path}/img/special/free_group/free_button2.png" alt="2020年あの人との恋を無料で占う" id="free_button2" onclick="checkParams( this.form );" name="free_button2" class="swapImage">
                                    </div>
                                    <div class="privacy">
