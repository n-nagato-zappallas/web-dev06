...
{if $list_work[0]}
              ...
              <div class="list_group work">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/result/list_group/work/section_title.jpg" alt="2020年あなたの仕事運"></h2>
...
{* 通常用 *}
              ...
              <div id="list_group2">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/list_group/work/section_title.jpg" alt="仕事運　「来年は給与アップする？　転職してもいい？」「2020年あなたの仕事運」"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
{if $list_work[0]}
                      <!-- パックメニュー個別リスト（一部無料なし） -->
