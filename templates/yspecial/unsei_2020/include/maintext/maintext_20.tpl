...
{/section}
                  ...
                  <div class="message_group special">
                    <div class="article_bdy">
                      <h3><img src="{$img_path}/img/special/result/message_group/{$contents}/section_title.jpg" alt="{if $contents == 'spshimada_zap'}ÅçÅÄ½¨Ê¿{elseif $contents == 'suisho_zap'}¿å¾½¶Ì»Ò{elseif $contents == 'fujiko_ccs'}ÌÚÂ¼Æ£»Ò{elseif $contents == 'evelourdes_zap'}¥¤¥ô¥ë¥ë¥Éô£²Ú{elseif $contents == 'baramon2_zap'}ÇÈÍåÌç{elseif $contents == 'kiseki_zap'}¾åÃÏ°ìÈþ{/if}¤«¤é¤Î¥á¥Ã¥»¡¼¥¸"></h3>
                      <div class="article_ftr">
                        <div class="article_hdr">
                          <div class="menu_bdy">
                            <div class="menu_ftr">
