              ...
              <div id="free_group1">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group/group1/section_title.jpg" alt="超豪華無料鑑定　1年の運勢がまるわかり！2020年のあなたの運勢を無料でズバリ鑑定！"></h2>
                    <h2><img src="{$img_path}/img/special/free_group/group1/section_hdr.jpg" alt="あなたの情報を入力してください"></h2>
                                  ...
                                  <div class="menu_hdr">
                                    <table class="input_tbl input_tbl_1" cellspacing="0">
                                      <tbody>
                                        ...
                                        <tr class="tr_kana">
                                          <th><label for="kana_last_self">よみがな</label></th>
                                          <td>
                                    ...
                                    <div class="form_btn">
                                      <input type="image" src="{$img_path}/img/special/free_group/free_button.png" alt="2020年の運勢を無料で占う" id="free_button" onclick="checkParams( this.form );" name="free_button" class="swapImage">
                                    </div>
                                    <div class="privacy">
