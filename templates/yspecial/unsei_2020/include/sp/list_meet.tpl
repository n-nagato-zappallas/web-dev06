...
{if $list_meet[0]}
              ...
              <div class="list_group meet">
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/list_group/meet/section_title.jpg" alt="2020年あなたの恋愛運"></h2>
...
{* 通常用 *}
              ...
              <div id="list_group3">
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/list_group/meet/section_title.jpg" alt="恋愛運　「今年は恋人ゲットできる？　恋は順調？」「2020年あなたの恋愛運"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
{if $list_meet[0]}
                      <!-- パックメニュー個別リスト（一部無料なし） -->
