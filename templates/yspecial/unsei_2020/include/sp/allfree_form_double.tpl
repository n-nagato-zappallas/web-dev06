              ...
              <div id="free_group2">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/group2/section_title.jpg" alt="二人の恋無料鑑定　あの人との恋は叶う？　2020年、あなたとあの人の恋　無料でズバリ鑑定！"></h2>
                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/group2/section_hdr.jpg" alt="あなたの情報を入力してください"></h2>
                              ...
                              <div class="menu_ftr">
                                <div class="menu_hdr">
                                  ...
                                  <div class="input_other">
                                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/group2/title2.jpg" alt="あの人の情報を入力してください"></h3>
                                    <table class="input_tbl" cellspacing="0">
                                      <tbody>
                                        <tr class="tr_name">
                                    ...
                                    <div class="form_btn">
                                      <input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/free_group/free_button2.png" alt="2020年あの人との恋を無料で占う" id="free_button2" onclick="checkParams( this.form );" name="free_button2" class="swapImage">
                                    </div>
                                    <div class="privacy">
