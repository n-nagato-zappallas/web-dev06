...
{if $menu_design_cd == 99}
                  <div class="text_img">
                    <img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/pack_text1.jpg" alt="運勢グラフ付きで毎月の運勢もバッチリわかる！　豪華2020年あなたの総合運　お得なパックはこちら">
                  </div>
{/if}
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/section_title.jpg" alt="豪華お得総合運パック　2020年の毎月の運勢グラフ付き！圧倒的な的中力の人気占い師6名があなたの2020年の運勢を完全鑑定！{if $isp == '70'}　それぞれ買うより5,900円以上もお得！※{elseif $isp == '40'}　それぞれ買うより5,900円以上もお得！※{else}　それぞれ買うより6,000円（税別）もお得※{/if}"></h2>
...
{if !$result_flag }
                        <p><a href="{$uri_path}/input/{if $isp == '11'}nu20_003{else}nu20_003{/if}.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="人気占い師6人による豪華特別鑑定！　「あなたの2020年運勢」豪華全網羅パック全78章" class="swapImage"></a></p>
  {if $isp == '70'}
...
{if $menu_design_cd == 99}
                        <p><input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="人気占い師6人による豪華特別鑑定！　「あなたの2020年運勢」豪華全網羅パック全78章" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/{if $isp == '11'}nu20_003{else}nu20_003{/if}.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="人気占い師6人による豪華特別鑑定！　「あなたの2020年運勢」豪華全網羅パック全78章" class="swapImage"></a></p>
{/if}
{if $isp == '70'}
