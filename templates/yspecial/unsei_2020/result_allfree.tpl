...
{if $menu_person == '1'}
                    <h2 id="point_title2"><img src="{$img_path}/img/special/result/point_group/single/section_title.jpg" alt="私たち6人があなたの2020年　1年分の運勢を占います"></h2>
{else}
                    <h2 id="point_title2"><img src="{$img_path}/img/special/result/point_group/double/section_title.jpg" alt="私たち6人が二人の2020年　1年分の運勢を占います"></h2>
{/if}
                      ...
                      <div class="section_hdr">
                        <div id="graph_base">
                          ...
                          <div id="point_result">
                            <div class="menu_bdy">
{if $menu_person == '1'}
                              <h3><img src="{$img_path}/img/special/result/point_group/single/menu_title.jpg" alt="2020年、あなたにとって最も良い運勢は"></h3>
{else}
                              <h3><img src="{$img_path}/img/special/result/point_group/double/menu_title.jpg" alt="2020年、二人にとって最も良い運勢は"></h3>
{/if}
                              <div class="menu_ftr">
                                <div class="menu_hdr">
...
{if $menu_person == '1'}
                          <h3><img src="{$img_path}/img/special/result/summary_group/title_single.jpg" alt="6人がそれぞれちょっとずつお見せします！　2020年あなたの運勢"></h3>
{else}
                          <h3><img src="{$img_path}/img/special/result/summary_group/title_double.jpg" alt="6人がそれぞれちょっとずつお見せします！　2020年の二人の恋"></h3>
{/if}
