...
{if $menu_person == '1'}
                    <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/section_title1.jpg" alt="人気占い師が占う！　2020年あなたの運勢グラフ"></h2>
{else}
                    <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/section_title2.jpg" alt="人気占い師が占う！　2020年二人の運勢グラフ"></h2>
{/if}
...
{/section}
                                ...
                                <div class="result_bg">
                                  <div class="graph_legend">
                                    <ul>
                                      <li><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/img.jpg" alt=""></li>
                                    </ul>
                                    <div class="clear"></div>
{if $isp == '70'}
                                    <p>※運勢グラフの結果は、6人の監修者毎に毎月の吉凶のポイントを合算し、合算値の低い月を注意すべき月としています。2020年を通しての結果では無く毎月の結果となるため、良い月としている監修者がいても注意すべき月となることがあります。</p>
{/if}
                                  </div>
                                  ...
                                  <div class="menu_hdr">
                                    <div class="menu_ftr">
                                      <div class="menu_bdy">
                                        <div class="mosaic">
                                          <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/trial/text.png" alt="有料版では2020年の一番良い月の運勢と注意すべき月の運勢が表示されます">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                        ...
                        <h4><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/title.jpg" alt="占い師画像をクリックすると、それぞれの結果まで移動します"></h4>
                        <noscript>
                          <p class="noscript_caption">当コンテンツをご利用になるにはJavaScriptをONにする必要があります。JavaScriptをONにしてお楽しみ下さい。</p>
                        </noscript>
                        <div class="pack_navi">
                          <ul>
                            <li><a href="#child_1"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/navi/spshimada_zap.jpg" alt="島田秀平"></a></li>
                            <li><a href="#child_2"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/navi/suisho_zap.jpg" alt="水晶玉子"></a></li>
                            <li><a href="#child_3"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/navi/fujiko_ccs.jpg" alt="木村藤子"></a></li>
                            <li><a href="#child_4"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/navi/evelourdes_zap.jpg" alt="イヴルルド遥華"></a></li>
                            <li><a href="#child_5"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/navi/baramon2_zap.jpg" alt="波羅門"></a></li>
                            <li><a href="#child_6"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/navi/kiseki_zap.jpg" alt="上地一美"></a></li>
                          </ul>
                          <div class="clear"></div>
                        </div>
                      </div>
