              ...
              <div id="free_group1" class="free_group">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group/section_title1.jpg" alt="完全無料鑑定一人用　豪華5人の占い師がお届け！　2020年下半期あなたの運勢鑑定書"></h2>
...
{include file="include/form/param_allfree.tpl"}
                        ...
                        <div id="inputForm">
                          ...
                          <div id="frmInput" style="display: none;">
                            ...
                            <div class="form_btn">
                              <input type="image" src="{$img_path}/img/special/free_group/free_button.png" alt="2020年下半期の運勢を無料で占う" title="2020年下半期の運勢を無料で占う" id="free_button" onclick="checkParams( this.form );" name="free_button" class="swapImage">
                            </div>
                            <div class="privacy">
{if $isp == '11'}
