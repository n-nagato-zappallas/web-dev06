...
{if $month_list && $month_list.single && $month_list.single.0}
              ...
              <div id="month_group1" class="month_group">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/month_group/group1/section_title_{$release_month}.jpg" alt="月運一人用　超人気占い師があなたを「毎月」占う！「{if $release_month|substr:4:1 == 0}{$release_month|substr:0:4}年{$release_month|substr:5:1}月{else}{$release_month|substr:0:4}年{$release_month|substr:4:2}月{/if}のあなたの運勢」"></h2>
