...
{if $list_love[0]}
              ...
              <div class="list_group love">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/result/list_group/love/section_title.jpg" alt="2020年あなたの恋愛運"></h2>
                        ...
                        <div class="menu_ftr">
                          <div class="menu_hdr">
                            <div class="severalmenu">
                              <div class="icon">
                                <img src="{$img_path}/img/special/contents/icon2/{$menu_list.contents}.png" alt="{$menu_list.teller_name}"><br>
                              </div>
                              <div class="menu_info">
...
<!--
              <div id="list_group1">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/list_group/love/section_title.jpg" alt="恋愛運　人気占い師5人がそれぞれ令和元年を占う！「2020年のあなたの恋愛運」"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
-->
