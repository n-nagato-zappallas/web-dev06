...
{if $list_life[0]}
              ...
              <div class="list_group life">
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/list_group/life/section_title.jpg" alt="2020年あなたの総合運"></h2>
...
<!--
              <div id="list_group1">
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/list_group/life/section_title.jpg" alt="総合運　人気占い師5人がそれぞれ令和元年を占う！「2020年のあなたの総合運」"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
-->
