                            ...
                            <div class="section_ftr">
                              <div class="section_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/basic/star/spshimada_zap/{$spshimada_zap.base_id_self}.png" alt="運命数：{$spshimada_zap.base_alt_self}">
                        ...
                        <div class="basic_sub1">
                          <div class="section_bdy">
                            ...
                            <div class="section_ftr">
                              <div class="section_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/basic/star/spshimada_zap/{$spshimada_zap.base_id_other}.png" alt="運命数：{$spshimada_zap.base_alt_other}">
...
{/section}
                      ...
                      <div class="message_group">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/main_all/message_group/spshimada_zap.jpg" alt="島田秀平からのメッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="ttl_bdy">
                                <div class="ttl_ftr">
                        ...
                        <div class="basic_sub1">
                          <div class="section_bdy">
                            ...
                            <div class="section_ftr">
                              <div class="section_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/basic/star/suisho_zap/{$suisho_zap.base_id_self}.png" alt="{$suisho_zap.base_alt_self}">
                        ...
                        <div class="basic_sub1">
                          <div class="section_bdy">
                            ...
                            <div class="section_ftr">
                              <div class="section_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/basic/star/suisho_zap/{$suisho_zap.base_id_other}.png" alt="{$suisho_zap.base_alt_other}">
...
{/section}
                      ...
                      <div class="message_group">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/main_all/message_group/suisho_zap.jpg" alt="水晶玉子からのメッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="ttl_bdy">
                                <div class="ttl_ftr">
...
{/section}
                      ...
                      <div class="message_group">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/main_all/message_group/fujiko_ccs.jpg" alt="木村藤子からのメッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="ttl_bdy">
                                <div class="ttl_ftr">
                        ...
                        <div class="basic_sub1">
                          <div class="section_bdy">
                            ...
                            <div class="section_ftr">
                              <div class="section_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/basic/star/akari_zap/{$akari_zap.base_id_self}.png" alt="{$akari_zap.base_alt_self}">
                        ...
                        <div class="basic_sub1">
                          <div class="section_bdy">
                            ...
                            <div class="section_ftr">
                              <div class="section_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/basic/star/akari_zap/{$akari_zap.base_id_other}.png" alt="{$akari_zap.base_alt_other}">
                              ...
                              <div class="menu_ftr">
                                <div class="menu_hdr">
                                  <div class="ttl_bdy">
                                    <div class="ttl_ftr">
                                      <div class="ttl_hdr">
                                        <h5>{$akari_zap.menu_min_title[$smarty.section.i.index]}</h5>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="detail_txt">
...
{/section}
                      ...
                      <div class="message_group">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/main_all/message_group/akari_zap.jpg" alt="真木あかりからのメッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="ttl_bdy">
                                <div class="ttl_ftr">
                                  <div class="ttl_hdr">
                                    <h5>{$akari_zap.menu_min_title[14]}</h5>
                                  </div>
                                </div>
                              </div>
                              <div class="detail_txt">
                                <p>{$akari_zap.result_menu[14]}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="basic_sub1">
                          <div class="section_bdy">
                            ...
                            <div class="section_ftr">
                              <div class="section_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/basic/star/kiseki_zap/{$kiseki_zap.base_id_self}.png" alt="霊数：{$kiseki_zap.base_alt_self}">
                        ...
                        <div class="basic_sub1">
                          <div class="section_bdy">
                            ...
                            <div class="section_ftr">
                              <div class="section_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/basic/star/kiseki_zap/{$kiseki_zap.base_id_other}.png" alt="霊数：{$kiseki_zap.base_alt_other}">
...
{/section}
                      ...
                      <div class="message_group">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/main_all/message_group/kiseki_zap.jpg" alt="上地一美からのメッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="ttl_bdy">
                                <div class="ttl_ftr">
                                  <div class="ttl_hdr">
                                    <h5>{$kiseki_zap.menu_min_title[14]}</h5>
                                  </div>
                                </div>
                              </div>
                              <div class="detail_txt">
                                <p>{$kiseki_zap.result_menu[14]}</p>
                              </div>
                            </div>
                          </div>
                        </div>
