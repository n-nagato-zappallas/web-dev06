...
{if $list_love[0]}
              ...
              <div class="list_group love">
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/list_group/love/section_title.jpg" alt="2020年あの人との恋愛成就鑑定"></h2>
...
{elseif $isp == '40'}
                                <p class="price_info right">{if $menu_list.discount_flag == 1}<strong class="price_discount">プレミアム価格 {$menu_list.discount}円＋税</strong><br>通常価格 {/if}{$menu_list.price}円＋税</p>
{else}
...
<!--
              <div id="list_group4">
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/list_group/love/section_title.jpg" alt="二人の恋　人気占い師6人がそれぞれ占う！　「2020年あの人との恋愛成就鑑定」"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
-->
...
{foreach name="menu_list" from=$list_love key="row_key" item="menu_list"}
                        ...
                        <div class="menu_ttl_bar2 menu_ttl_{$menu_list.contents}">
                          <div class="menu_bdy{if $smarty.foreach.menu_list.iteration is even } right{else} left{/if}">
                            <div class="menu_ftr">
                              <div class="menu_hdr">
                                <div class="arror">
