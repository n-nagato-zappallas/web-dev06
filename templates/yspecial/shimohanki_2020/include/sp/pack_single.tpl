...
{if $menu_design_cd == 99}
                  <div class="text_img">
                    <img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/pack_text1.jpg" alt="下半期年表付きで毎月の運勢が一目でわかる！　2020年あなたの総合運　お得なパックはこちら">
                  </div>
{/if}
                <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/section_title.jpg" alt="特集限定!!　超豪華総合運パック　2020年下半期年表で毎月の運勢も大公開！　超人気占い師5人があなたの総合運を全力鑑定{if $isp == '70'}　個別で買うよりパックなら4,900円以上もお得！※{elseif $isp == '40'}　個別で買うよりパックなら4,900円以上もお得！※{else}　個別で買うよりパックなら5,000円（税別）もお得※{/if}"></h2>
...
{if !$result_flag }
                        <p><a href="{$uri_path}/input/li20_005.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="ココでしか占えない！　【2020年下半期あなたの総合運】全網羅パック65章" class="swapImage"></a></p>
{if $isp == '70'}
...
{if $menu_design_cd == 99}
                        <p><input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="ココでしか占えない！【2020年下半期あなたの総合運】全網羅パック65章" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/li20_005.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="ココでしか占えない！【2020年下半期あなたの総合運】全網羅パック65章" class="swapImage"></a></p>
{/if}
{if $isp == '70'}
