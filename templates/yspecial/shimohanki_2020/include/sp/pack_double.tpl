...
{if $menu_design_cd == 99}
                  <div class="text_img">
                    <img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/pack_text2.jpg" alt="下半期年表付きで二人の毎月の運勢が一目でわかる！　2020年下半期、二人の恋愛運　超豪華なパックはこちら">
                  </div>
{/if}
                <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group2/section_title.jpg" alt="特集限定!!　豪華パック恋愛総合　二人の2020年下半期年表で毎月の運勢もまるわかり！　TVやメディアで超人気の占い師が二人の恋を成就へ導きます！{if $isp == '70'}　個別で買うよりパックなら4,900円以上もお得！※{elseif $isp == '40'}　個別で買うよりパックなら4,900円以上もお得！※{else}　個別で買うよりパックなら5,000円（税別）もお得※{/if}"></h2>
...
{if !$result_flag || $result_flag && $menu_person == '1'}
                        <p><a href="{$uri_path}/input/li20_006.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group2/btn.png" alt="超人気占い師5人による豪華恋愛鑑定【2020年下半期◆二人の恋運命】恋愛スペシャルパック" class="swapImage"></a></p>
{if $isp == '70'}
...
{if $menu_design_cd == 99}
                        <p><input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/pack_group/group2/btn.png" alt="超人気占い師5人による豪華恋愛鑑定【2020年下半期◆二人の恋運命】恋愛スペシャルパック" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/li20_006.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group2/btn.png" alt="超人気占い師5人による豪華恋愛鑑定【2020年下半期◆二人の恋運命】恋愛スペシャルパック" class="swapImage"></a></p>
{/if}
{if $isp == '70'}
                        ...
                        通常価格{literal}　<strong class="price_discount">{YJPRICE_5000}</strong>{/literal}</p>
{elseif $isp == '40'}
                        <p class="price_info">プレミアム価格　<strong class="price_discount">4,500円＋税</strong>&nbsp;/&nbsp;
                        通常価格　<strong class="price_discount">5,000円＋税</strong></p>
{else}
                        <p class="price_info">5,000円（税別）</p>
{/if}
                        </form>
{* //完全無料二人用結果ページ用 *}
{/if}
