              ...
              <div id="trial_group" class="next_main_group">
                <h3>
                  <img src="{$uri_path}/img/special/result/navi/text.jpg" alt="5人それぞれの鑑定は単品メニューでもご利用頂けます">
                  <p class="next_attention2">以下は上記パックに含まれているメニューです<br>※占い師画像をクリックすると単品メニューまで移動します</p>
                </h3>
...
{if $menu_person == '2'}
                  <h2><img src="{$uri_path}/img/special/result/trial_group/group2/section_title.jpg" alt="あの人との恋　豪華占い師5人がそれぞれ占う！　2020年下半期の二人の恋と運命"></h2>
{else}
                  <h2><img src="{$uri_path}/img/special/result/trial_group/group1/section_title.jpg" alt="総合運　超人気占い師5人がそれぞれ占う！　2020年下半期のあなたの総合運"></h2>
{/if}
                          ...
                          <div class="article_bdy">
                            <div class="article_ftr">
                              <div class="article_hdr">
                                ...
                                <div class="telling">
                                  <h3><img src="{$uri_path}/img/special/result/trial_group/telling/telling_title.png" alt="このメニューでは以下の項目が占えます"></h3>
                                  <div class="menu_bdy">
                                    <div class="menu_ftr">
                                      <div class="menu_hdr">
                                        <ol>
