...
{if $menu_design_cd >= '50'}
                      <h2><img src="{$img_path}/img/special/title/{$menu_id}.jpg" alt="{$menu_title}"></h2>
{else}
                        ...
                        <div class="article_bdy">
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <h3><img src="{$img_path}/img/special/input/input_frm/article_hdr_self.png" alt="あなたの情報を入力してください"></h3>
                              <div class="menu_bdy">
                                <div class="menu_ftr">
                                  <div class="menu_hdr">
...
{if $menu_person == '2' }
                                    <div class="input_other">
                                      <h3><img src="{$img_path}/img/special/input/input_frm/article_hdr_other.png" alt="あの人の情報を入力してください"></h3>
                                      <table class="input_tbl" cellspacing="0">
                                        <tr class="tr_name">
                                          <th><label for="name_last_other">&nbsp;姓&nbsp;</label></th>
                                          <td>
                                            <input type="text" id="name_last_other" name="name_last_other" size="8" maxlength="8" class="input_name">
                                        ...
                                        <tr class="tr_kana">
                                          <th><label for="kana_last_other">せい</label></th>
                                          <td>
                                            <input type="text" id="kana_last_other" name="kana_last_other" size="8" maxlength="8" class="input_name">
