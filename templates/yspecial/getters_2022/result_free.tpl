        ...
        <div id="basebdy">
          ...
          <div id="contents">
            <div id="contents_inner">
              <div id="topicpath">
{if $isp == '11'}
                <p><a href="https://honkaku-uranai.jp/moon/">cocoloni占い館 Moon Top</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/">ゲッターズ飯田2022年運特集</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/input/{$menu_id}.html">{$menu_title}</a>&nbsp;&gt;&nbsp;一部無料鑑定結果</p>
{else}
...
{if $menu_design_cd == '15'}
                        ...
                        <div class="graph_sub1" id="graph_sub1">
                          <div class="graph_outer">
                            <img src="{$img_path}/img/special/result/graph_group/img1.png" alt="パック特典" class="pack_icon">
                            <div class="article_bdy">
                            ...
                            <div class="article_bdy">
                              <div class="article_ftr">
                                ...
                                <table border="0" cellspacing="0">
                                  <tr class="left">
                                    <td>
                                      <img src="{$img_path}/img/special/result/graph_group/group1/text_year/1.png" alt="2022年" class="img1">
                                      <img src="{$img_path}/img/special/result/graph_group/group1/text_result/mosaic.png" alt="">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                    <td>
                                      <img src="{$img_path}/img/special/result/graph_group/group1/text_year/2.png" alt="2022年" class="img1">
                                      <img src="{$img_path}/img/special/result/graph_group/group1/text_result/mosaic.png" alt="">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
...
{/if}
                        ...
                        <div class="graph_sub2" id="graph_sub2">
                          <div class="article_bdy">
                            ...
                            <div class="article_ftr">
                              <div class="article_hdr">
                                <div class="graph_bdy graph_trial {if $year_now == '2021'}month_1{else}month_{$month_now}{/if}">
{if $year_now == '2021'}
