...
{if $menu_id == 'gs22_001'}
                ...
                <div class="result_basic">
                  <div class="section_bdy">
                    <h2>
                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/free_group/group1/section_title.jpg" alt="今すぐチェック！　五星三心占いを無料で体験！あなたにとって2022年はどんな年？ゲッターズ飯田の五星三心占いであなたの星と運勢を無料で鑑定！">
                    </h2>
...
{else}
                ...
                <div class="result_weekly">
                  <div class="section_bdy">
                    <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/free_group/group2/section_title.jpg" alt="1週間の運勢を先読み！　今日から1週間先の運勢を五星三心占いでお届け！　2022年、始まる前も始まってからも気持ちよく過ごせるよう日々の指針にしてください。"></h2>
                    <div class="section_ftr">
                      <div class="section_hdr">
                        <div class="basic_sub1">
