...
{if $menu_design_cd >= '15'}
                      <h2 class="menu_ttl_bar"><img src="{$img_path}/img/special/title/{$menu_id}.jpg" alt="“芸能界最強”ゲッターズ飯田が2022年のあなたを最高な年に導く！　2022年あなたの3大運勢　総合・仕事・恋◆豪華開運パック　開運3か条・月運グラフ＆12年周期グラフ付き！"></h2>
{else}
