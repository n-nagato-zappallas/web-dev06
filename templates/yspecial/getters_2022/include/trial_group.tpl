...
{if $menu_id == 'gs22_001'}
                <!-- 無料1人用(gt21_001年運) -->
                <h3><img src="{$img_path}/img/special/result/navi/text.jpg" alt="個別に運勢を知りたい方はこちらから！"><br>以下は上記パックに含まれているメニューです</h3>
{include file="include/pack_navi.tpl"}
{else}
                <h3><img src="{$img_path}/img/special/result/next_group/text1.jpg" alt="今のあなたにおすすめの2022年運勢メニュー！"></h3>
{/if}
...
{if $menu_list.contents == 'getters1'}
                                          <li class="main">2022年のあなたの総合運【全8項目】</li>
{elseif $menu_list.contents == 'getters2'}
                                          <li class="main">2022年のあなたの仕事お金運【全4項目】</li>
{elseif $menu_list.contents == 'getters3'}
                                          <li class="main">2022年のあなたの恋愛結婚運【全4項目】</li>
{else}
                                          <li class="main">2022年のあなたの健康家庭運【全4項目】</li>
{/if}
