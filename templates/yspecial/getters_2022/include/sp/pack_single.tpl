...
{if $result_flag }
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/pack_group/section_title.jpg" alt="“芸能界最強”ゲッターズ飯田が2022年のあなたを最高な年に導く！　総合運　金運　結婚運　仕事運　恋愛運　健康運　あなたの2022年の運勢を完全鑑定！"></h2>
{else}
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/section_title.jpg" alt="オススメ本格鑑定！　もっと本格的に占いたいあなたへ！　“芸能界最強”ゲッターズ飯田が2022年のあなたを最高な年に導く！　総合運　金運　結婚運　仕事運　恋愛運　健康運　あなたの2022年の運勢を完全鑑定！　月運＆12年周期グラフ＋概要付き！{if $isp == '70'}　それぞれ買うより835円（税込）お得！※{else}　それぞれ買うより800円（税込）お得！※{/if}"></h2>
{/if}
...
{if !$result_flag }
                        <p><a href="{$uri_path}/input/gs22_003.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/btn.png" alt="2022年あなたの3大運勢　総合・仕事・恋◆豪華開運パック" class="swapImage"></a></p>
  {if $isp == '70'}
...
{if $menu_design_cd == 99}
                        <p><input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/pack_group/btn.png" alt="2022年あなたの3大運勢　総合・仕事・恋◆豪華開運パック" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/gs22_003.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/btn.png" alt="2022年あなたの3大運勢　総合・仕事・恋◆豪華開運パック" class="swapImage"></a></p>
{/if}
{if $isp == '70'}
