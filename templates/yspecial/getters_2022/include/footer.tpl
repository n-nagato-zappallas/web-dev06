...
{if $isp == '70'}
                <div id="footernavi">
                  <p class="alignC"><a href="https://charge-fortune.yahoo.co.jp/zap/event/{$event}/">特集トップ</a>｜<a href="https://fortune.yahoo.co.jp/">Yahoo!占い </a> | <a href="https://www.yahoo.co.jp/">Yahoo! JAPAN</a><br>
                    <a href="https://privacy.yahoo.co.jp/">プライバシー</a> - <a href="https://about.yahoo.co.jp/common/terms/">利用規約</a> - <a href="https://www.yahoo-help.jp/app/answers/detail/p/547/a_id/43426">免責事項</a> - <a href="/zap/common/notice.html" target="_blank">特定商取引法の表示</a> - <a href="https://www.yahoo-help.jp/app/home/p/547/">ヘルプ・お問い合わせ</a>
                  </p>
                </div>
                ...
                <div id="breadcrumblist">
                  <div class="linkbox">
                    <div class="linkbox_inner">
                      <span class="def"></span><input type="hidden" name="contents_name" value="getters_2022">
                    </div>
                  </div>
                </div>
{/if}
