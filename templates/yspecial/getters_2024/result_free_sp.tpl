...
<h2 class="menu_ttl_bar"><img src="{$img_path}/img_sp/special/title/gq24_003.jpg" alt="ゲッターズ飯田の五星三心占いであなたの2024年を開運へ！　2024年あなたの3大運勢　“総合・仕事・恋”特別開運パック　開運3か条・月運グラフ＆12年周期グラフ付き！" data-popupalt-original-title="null" title="ゲッターズ飯田の五星三心占いであなたの2024年を開運へ！　2024年あなたの3大運勢　“総合・仕事・恋”特別開運パック　開運3か条・月運グラフ＆12年周期グラフ付き！"></h2>
{/if}
{if $menu_design_cd != '15'}
                            ...
                            <div class="article_bdy">
                              <div class="article_ftr">
                                ...
                                <table border="0" cellspacing="0">
                                  <tr class="left">
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/1.png" alt="2024年" class="img1">
                                  ...
                                  <tr>
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/2.png" alt="2025年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr class="right">
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/3.png" alt="2026年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr>
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/4.png" alt="2027年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr class="left">
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/5.png" alt="2028年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr>
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/6.png" alt="2029年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr class="right">
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/7.png" alt="2030年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr>
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/8.png" alt="2031年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr class="left">
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/9.png" alt="2032年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr>
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/10.png" alt="2033年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr class="right">
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/11.png" alt="2034年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
                                  ...
                                  <tr>
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/12.png" alt="2035年" class="img1">
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_result/mosaic.png" alt="" class="img2">
                                      <div class="clear"></div>
                                      <div class="mosaic"></div>
                                    </td>
...
{/if}
                        ...
                        <div class="graph_sub2" id="graph_sub2">
                          <div class="article_bdy">
                            ...
                            <div class="article_ftr">
                              <div class="article_hdr">
                                <div class="graph_bdy graph_trial {if $year_now == '2023'}month_1{else}month_{$month_now}{/if}">
{if $year_now == '2023'}
...
{if $isp == '11'}
              <div id="topicpath">
                <p><a href="https://honkaku-uranai.jp/moon/">cocoloni占い館 Moon Top</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/">ゲッターズ飯田◆2024年運勢特集</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/input/{$menu_id}.html">{$menu_title}</a>&nbsp;&gt;&nbsp;一部無料鑑定結果</p>
              </div>
{/if}
</article>
