...
<!--
              <div id="header_nav">
                <ul>
                  <li><a href="#free_group1" ><img width="100%" height="auto" src="{$img_path}/img_sp/special/navi/navi01.png" alt="無料で占う　2024年の運勢" class="swapImage"></a></li>
...
<!--
              <div id="new_group">
                <p class="form_link"><a href="#free_group2">※【二人用無料鑑定はこちら】2023年のあなたとあの人の恋を占う※</a></p>
{if $isp == '70'}
...
{if $isp == '11'}
              <div id="topicpath">
                <p><span class="def"></span><input type="hidden" name="contents_name" value="getters_2024">&nbsp;&gt;&nbsp;{$special_title}</p>
              </div>
{/if}
</article>
{if $isp == '11'}
