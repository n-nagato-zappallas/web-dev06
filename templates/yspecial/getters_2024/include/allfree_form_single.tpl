              ...
              <div id="free_group1" class="free_group">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group/section_title.jpg" alt="無料鑑定はこちら！　まずは五星三心占いであなたのタイプと2024年運勢の一部をチェックしてみましょう！"></h2>
                              ...
                              <div class="menu_bdy">
                                <div class="menu_ftr">
                                  <div class="menu_hdr">
                                    ...
                                    <div class="form_btn">
                                      <input type="image" src="{$img_path}/img/special/free_group/free_button.png" alt="無料で鑑定する" title="無料で鑑定する" id="free_button" onclick="checkParams( this.form );" name="free_button" class="swapImage">
                                    </div>
                                    <div class="privacy">
{if $isp == '11'}
