...
{if $result_flag }
                  <h2><img src="{$img_path}/img/special/result/pack_group/section_title.jpg" alt="書籍はシリーズ累計1000万部突破！　ゲッターズ飯田の五星三心占いであなたの2024年を開運へ！　月運＆12年周期グラフ＋概要付き！　占うだけで運気があがる！　↓特別鑑定はこちら↓"></h2>
{else}
                  <h2><img src="{$img_path}/img/special/pack_group/section_title.jpg" alt="運勢を詳しく知りたい方は必見！　2024年の運勢丸ごと鑑定　書籍はシリーズ累計1000万部突破！　ゲッターズ飯田の五星三心占いであなたの2024年を開運へ！　月運＆12年周期グラフ＋概要付き！　占うだけで運気があがる！　↓特別鑑定はこちら↓"></h2>
{/if}
...
{if !$result_flag }
                        <div><a href="{$uri_path}/input/gq24_003.html"><img src="{$img_path}/img/special/pack_group/btn.png" alt="2024年あなたの3大運勢　“総合・仕事・恋”特別開運パック" class="swapImage"></a></div>
                        <p class="price_info ttl_font">1,650円（税込）</p>
{else}

                        <h2><img src="{$img_path}/img/special/result/pack_group/img1.png" alt="それぞれ買うより800円以上もお得！※"></h2>
{if $menu_design_cd == 99}
                        <p><input type="image" src="{$img_path}/img/special/pack_group/btn.png" alt="2024年あなたの3大運勢　“総合・仕事・恋”特別開運パック" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/gq24_003.html"><img src="{$img_path}/img/special/pack_group/btn.png" alt="2024年あなたの3大運勢　“総合・仕事・恋”特別開運パック" class="swapImage"></a></p>
{/if}
                        <p class="price_info ttl_font">1,650円（税込）</p>
                        </form>
{* //完全無料一人用結果ページ用 *}
