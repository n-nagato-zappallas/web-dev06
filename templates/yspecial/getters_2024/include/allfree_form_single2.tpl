              ...
              <div id="free_group2" class="free_group">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group2/section_title.jpg" alt="期間限定無料で先読み!!　占った日から一週間の運勢をお届け！　どんなタイプの人でも運気のいいときに動くことが開運のコツです！"></h2>
...
{include file="include/form/param_allfree_2.tpl"}
                        ...
                        <div id="inputForm2">
                          ...
                          <div id="frmInput2" style="display: none;">
                            ...
                            <div class="form_btn">
                              <input type="image" src="{$img_path}/img/special/free_group2/free_button2.png" alt="無料で鑑定する" title="無料で鑑定する" id="free_button2" onclick="checkParams( this.form );" name="free_button2" class="swapImage">
                            </div>
                            <div class="privacy">
{if $isp == '11'}
