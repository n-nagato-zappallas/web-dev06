...
{if $isp == '70'}
              <p class="form_link" style="padding-top: 10px;text-align:center;">※1週間の運勢は2024年1月31日まで</a></p>
{/if}
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group2/section_title.jpg" alt="期間限定無料で先読み！！　占った日から一週間の運勢をお届け！　どんなタイプの人でも運気のいいときに動くことが開運のコツです！"></h2>
                              ...
                              <div class="menu_ftr">
                                <div class="menu_hdr">
                                  <div class="input_self">
                                    ...
                                    <div class="form_btn">
                                      <input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/free_group2/free_button2.png" alt="無料で鑑定する" id="free_button2" onclick="checkParams( this.form );" name="free_button2" class="swapImage">
                                    </div>
                                    <div class="privacy">
{if $isp == '11'}
