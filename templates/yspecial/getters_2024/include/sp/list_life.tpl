...
{if $list_life[0]}
              ...
              <div class="list_group life">
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/list_group/life/section_title.jpg" alt="2024年あなたの総合運"></h2>
...
{* 通常用 *}
              ...
              <div id="list_group1">
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/list_group/section_title.jpg" alt="個別に運勢を知りたい方はこちら！　テーマ別運勢鑑定　総合運 仕事運 恋愛運 健康運　2024年のあなたのそれぞれの運勢は？"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
{if $list_life[0]}
                      <!-- パックメニュー個別リスト（一部無料なし） -->
