...
{if $result_flag}
      <div id="footernavi">
        <ul>{strip}
          ...
          <li><a href="https://honkaku-uranai.jp/cp_zap/{$event}/">ゲッターズ飯田◆2024年運勢特集 Top</a>&nbsp;</li>
          <li><a href="https://honkaku-uranai.jp/sitemap/">サイトマップ</a></li>
        {/strip}</ul>
      </div>
      <div class="clear"></div>
      <p class="contents_footerCopy">人気の占いを集めた占いポータルサイトcocoloni占い館 Moon | <span class="cp_zap_short_title">ゲッターズ飯田◆2024年運勢特集</span></p>
