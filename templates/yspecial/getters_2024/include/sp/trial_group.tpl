...
{if $menu_id == 'gq24_001'}
                <!-- 無料1人用(gt21_001年運) -->
                <h3 class="menu_ttl h3_navi_text"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/navi/text.jpg" alt="個別に運勢を知りたい方はこちら！　テーマ別運勢鑑定"><p class="navi_text ttl_font">※以下は上記パックに<br>含まれているメニューです</p></h3>
                
{include file="include/sp/pack_navi.tpl"}
{else}
                <h3 class="menu_ttl"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/next_group/text1.jpg" alt="今のあなたにおすすめの2024年運勢メニュー！"></h3>
{/if}
