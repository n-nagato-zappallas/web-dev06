...
{if $menu_id == 'gq24_001'}
                <!-- 無料1人用(gt21_001年運) -->
                <h3><img class="trial_group_h3_img" src="{$img_path}/img/special/result/navi/text.jpg" alt="個別に運勢を知りたい方はこちら！　テーマ別運勢鑑定">
                  <p>※以下は上記パックに含まれているメニューです</p>
                </h3>
{include file="include/pack_navi.tpl"}
{else}
                <h3><img src="{$img_path}/img/special/result/next_group/text1.jpg" alt="今のあなたにおすすめの2024年運勢メニュー！"></h3>
{/if}
