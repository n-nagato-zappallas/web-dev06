...
{if $isp == '70'}
                <div id="footernavi">
                  ...
                  Copyright (C) 2019 Yahoo Japan Corporation. All Rights Reserved.<br>
                  </small></p>
...
{if $isp == '40'}
                ...
                <div id="zp_footer">
                  ...
                  <div id="ispInfo">
                    <div><a href="http://www.nifty.com/" target="_nifty" title="アット・ニフティトップページへ"><img src="{$uri_path}/img/special/common/nifty_top.gif" alt="アット・ニフティトップページへ" title="アット・ニフティトップページへ"></a>&nbsp;<a href="http://www.nifty.com/users/signup/indexf.htm" target="_nifty" title="アット・ニフティ会員に登録"><img src="{$uri_path}/img/special/contents/register.gif" alt="アット・ニフティ会員に登録" title="アット・ニフティ会員に登録" /></a></div>
