...
{if $month_list && $month_list.single && $month_list.single.0}
              ...
              <div id="month_group1" class="month_group">
                <div class="section_bdy">
                  <h2><img src="{$uri_path}/img/special/month_group/section_title_{$release_month}.jpg" alt="月運メニュー　「今月何が起こる？」「恋や仕事に変化は？」あなたを待ち受ける運命は？　毎月更新！　今月の運勢を今すぐチェック！「{if $release_month|substr:4:1 == 0}{$release_month|substr:0:4}年{$release_month|substr:5:1}月{else}{$release_month|substr:0:4}年{$release_month|substr:4:2}月{/if}のあなたの運勢」"></h2>
                        ...
                        <div class="menu_ftr">
                          <div class="menu_hdr">
                            <div class="severalmenu">
                              <div class="icon">
                                <img src="{$uri_path}/img/special/contents/icon/{$menu_list.contents}.png" alt="{$menu_list.teller_name}"><br>
                              </div>
                              <div class="menu_info">
