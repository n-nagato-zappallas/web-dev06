...
<!-- SNS -->
  <div class="sns">
    ...
    <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://charge-fortune.yahoo.co.jp/zap/event/{$event}/" data-text="島田秀平、水晶玉子、紫月香帆、波羅門、飯塚唯の人気占い師5人が令和元年の2019年下半期、あなたの運勢と幸運な日を無料で鑑定" data-hashtags="ヤフー占い,2019年の下半期の運勢,無料占い">Tweet</a><script>!function(d,s,id){literal}{{/literal}var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){literal}{{/literal}js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);{literal}}}{/literal}(document, 'script', 'twitter-wjs');</script>
    <div class="line-it-button" data-lang="ja" data-type="share-a" data-url="Yahoo!占い　令和元年の貴方の運勢/幸運日を人気占い師が鑑定◆2019年下半期特集  https://charge-fortune.yahoo.co.jp/zap/event/shimohanki_2019/index.html" style="display: none;"></div>
...
<script type="text/javascript" src="https://lovefortune.zappallas.com/sp/rakuten/event/shimohanki_2019/js_sp/rakuten_sp.js"></script>
...
<article>
<!-- ========== header ========== -->
<script type="text/javascript" src="https://honkaku-uranai.jp/sp/cp_zap/event/shimohanki_2019/js_sp/cp_zap_sp.js?ver=201908"></script>
<div id="isp_header" style="display:none;"></div>
<!-- ========== /header ========== -->
<h1 class="contents_headerCopy">令和元年の貴方の運勢/幸運日を人気占い師が鑑定◆2019年下半期特集</h1>
{/if}
