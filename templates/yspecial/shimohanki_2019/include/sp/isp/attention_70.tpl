...
<section id="attention">
  <h3><img width="100%" height="auto" src="{$uri_path}/img_sp/special/attention.png" alt="注意事項"></h3>
  <div class="attentionBody">
    ...
    <div class="attentionBody">
      ...
      <ul class="attentionLink">
        <li><p>この特集に関するお問い合わせは<a href="mailto:web-customer@ml.zappallas.com?subject=Yahoo!占い-{$special_title}に関するお問い合わせ&body=お問い合わせの内容：%0D%0A（できるだけ詳細にご記入ください。）%0D%0A%0D%0A">こちら</a>から行ってください。</p></li>
