...
{if $list_extra}
              ...
              <div class="rec_double" id="extra_group">
                <div class="section_bdy">
                  <h3><img width="100%" height="auto" src="{$uri_path}/img_sp/special/rec_double/section_title.jpg" alt="まだまだあります！　今話題の人気占い師が占う　あなたの2019年、後半の運勢"></h3>
                        ...
                        <div class="menu_bdy severalmenu2" data-no="{$group_key}" data-price="{$item_list.menu_price}" data-chara="{$item_list.chara}" data-charano="{$item_list.charano}">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              ...
                              <a href="{$item_list.menu_url}" target="_contents">
                              <div class="severalmenu">
{if $item_list.new && $isp == '70'}
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/rec_double/new.png" alt="" class="icon_new">
{/if}
                                <div class="icon">
                                  <img width="100%" height="auto" src="{$uri_path}/img_sp/special/rec_double/banner/{$item_list.img_name}.jpg" alt="{$item_list.teller_name}" class="icon_category"><br>
                                </div>
                                <div class="menu_ttl">
                                ...
                                <div class="clear"></div>
{if $isp == '70'}
                                <p class="price_info"><strong class="price_discount">会員価格 {literal}{YJPRICE_{/literal}{$item_list.menu_discount}{literal}}{/literal}</strong><br>通常価格 {literal}{YJPRICE_{/literal}{$item_list.menu_price}{literal}}{/literal}</p>
{elseif $isp == '40'}
                                <p class="price_info">{if $item_list.discount_flag == 1}<strong class="price_discount">プレミアム価格 {$item_list.menu_discount}円＋税</strong><br>通常価格 {/if}{$item_list.menu_price}円＋税</p>
{else}
