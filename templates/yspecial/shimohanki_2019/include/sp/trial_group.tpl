              ...
              <div id="trial_group" class="next_main_group">
                <p class="ttl_font navi_click_txt">5人それぞれの鑑定は<br>単品メニューでもご利用いただけます</p>
                <p class="ttl_font navi_click_txt2">以下は上記パックに含まれているメニューです<br>※占い師画像をタップすると<br>単品メニューまで移動します</p>
