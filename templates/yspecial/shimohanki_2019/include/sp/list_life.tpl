{* 1人用個別メニュー（総合運） *}
              <!-- 1人用個別メニュー（総合運） -->
              <div id="list_group1">
                <h2><img width="100%" height="auto" src="{$uri_path}/img_sp/special/list_group/life/section_title.jpg" alt="総合運　人気占い師5人がそれぞれ令和元年を占う！「2019年下半期のあなたの総合運」"></h2>
...
{if $smarty.foreach.menu_list.iteration == '1'}
                          <img width="100%" height="auto" src="{$uri_path}/img_sp/special/list_group/life/text1.jpg" alt="数々の芸能人を鑑定、開運してきた各方面で大活躍の人気占い師！">
{elseif $smarty.foreach.menu_list.iteration == '2'}
                          <img width="100%" height="auto" src="{$uri_path}/img_sp/special/list_group/life/text2.jpg" alt="女性誌で絶大な支持を受けあのカリスマ占い師も慕う！">
{if $isp != '40'}
...
{elseif $smarty.foreach.menu_list.iteration == '3'}
                          <img width="100%" height="auto" src="{$uri_path}/img_sp/special/list_group/life/text3.jpg" alt="書籍ベストセラーの実力　テレビやイベントでも大活躍！">
{if $isp != '40'}
...
{elseif $smarty.foreach.menu_list.iteration == '4'}
                          <img width="100%" height="auto" src="{$uri_path}/img_sp/special/list_group/life/text4.jpg" alt="驚異的な霊能力で全てを視通す新大阪の怪物級霊能者！">
{elseif $smarty.foreach.menu_list.iteration == '5'}
                          <img width="100%" height="auto" src="{$uri_path}/img_sp/special/list_group/life/text5.jpg" alt="当たり過ぎてテレビ収録中断三代目ギャル霊媒師！">
{if $isp != '40'}
                          <p class="point{$smarty.foreach.menu_list.iteration}_1">※</p>
...
{/if}
                        ...
                        <div class="menu_bdy">
                          <h3><img width="100%" height="auto" src="{$uri_path}/img_sp/special/list_group/title/{$menu_list.menu_id}.jpg" alt="{$menu_list.title}"></h3>
{if $isp == '70'}
