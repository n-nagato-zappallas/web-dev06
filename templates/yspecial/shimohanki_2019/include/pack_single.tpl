...
{if $menu_design_cd == 99}
                  <div class="text_img">
                    <img src="{$uri_path}/img/special/pack_group/pack_img.jpg" alt="ちょっと待ってください！実は、2019年下半期の運勢には、先ほど伝えた以外にも大事な日があるのです！　新時代の幕開け、令和最初の年の恋愛、仕事、出会いの幸運日がわかる！{if $isp == '70'}　それぞれ買うより4,800円以上もお得！※{elseif $isp == '40'}　それぞれ買うより4,500円+税以上もお得！※{else}　それぞれ買うより5,000円（税別）お得！{/if}">
                  </div>
{else}
                  <h2><img src="{$uri_path}/img/special/pack_group/section_title.jpg" alt="豪華パック得総合運　新時代の幕開け、令和最初の年の恋愛、仕事、出会いの幸運日がわかる！人気占い師5人があなたの2019年下半期の運勢を完全鑑定！{if $isp == '70'}　それぞれ買うより4,800円以上もお得！※{elseif $isp == '40'}　それぞれ買うより4,500円+税以上もお得！※{else}　それぞれ買うより5,000円（税別）お得！{/if}"></h2>
{/if}
...
{if !$result_flag }
                        <p><a href="{$uri_path}/input/{if $isp == '11'}lh19_02{else}sh2019_0002{/if}.html"><img src="{$uri_path}/img/special/pack_group/button.png" alt="【令和元年記念パック】人気占い師が結集2019年下半期あなたの運勢" class="swapImage"></a></p>
{if $isp == '70'}
...
{/if}
{if $menu_design_cd == 99}
                        <p><input type="image" src="{$uri_path}/img/special/pack_group/button.png" alt="【令和元年記念パック】人気占い師が結集2019年下半期あなたの運勢" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/{if $isp == '11'}lh19_02{else}sh2019_0002{/if}.html"><img src="{$uri_path}/img/special/pack_group/button.png" alt="【令和元年記念パック】人気占い師が結集2019年下半期あなたの運勢" class="swapImage"></a></p>
{/if}
{if $isp == '70'}
