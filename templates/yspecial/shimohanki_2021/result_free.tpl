...
{* パックメニュー用ナビ *}
{if $menu_design_cd == '60'}
                <h4><img src="{$img_path}/img/special/result/graph_group/text.jpg" alt="占い師画像をクリックすると、それぞれの結果まで移動します"></h4>
                <noscript>
                  <p class="noscript_caption">当コンテンツをご利用になるにはJavaScriptをONにする必要があります。JavaScriptをONにしてお楽しみ下さい。</p>
                </noscript>
                <div class="pack_navi">
                  <ul class="tr_1">
                    <li><a href="#child_1"><img src="{$img_path}/img/special/result/graph_group/navi/icon1.png" alt="星ひとみ"></a></li>
                    <li><a href="#child_2"><img src="{$img_path}/img/special/result/graph_group/navi/icon2.png" alt="島田秀平"></a></li>
                    <li><a href="#child_3"><img src="{$img_path}/img/special/result/graph_group/navi/icon3.png" alt="水晶玉子"></a></li>
                    <li><a href="#child_4"><img src="{$img_path}/img/special/result/graph_group/navi/icon4.png" alt="シウマ"></a></li>
                  </ul>
                  <ul class="tr_2">
                    <li><a href="#child_5"><img src="{$img_path}/img/special/result/graph_group/navi/icon5.png" alt="木村藤子"></a></li>
                    <li><a href="#child_6"><img src="{$img_path}/img/special/result/graph_group/navi/icon6.png" alt="岡井浄幸"></a></li>
                    <li><a href="#graph_group"><img src="{$img_path}/img/special/result/graph_group/navi/icon7.png" alt="限定特典"></a></li>
                  </ul>
                  <div class="clear"></div>
                </div>
{/if}
...
{if $menu_design_cd == '60'}
                ...
                <div id="graph_group">
                  ...
                  <h2>
                    <img src="{$img_path}/img/special/result/graph_group/section_title.jpg" alt="あなたの特別鑑定書">
                            ...
                            <div class="menu_hdr">
                              ...
                              <div class="best_date"">
                                <div class="best_date_inner">
                                  ...
                                  <img src="{$img_path}/img/special/result/graph_group/title.png" alt="最強幸運期" class="title_best">
                          ...
                          <div class="menu_bdy">
                            <div class="menu_ftr">
                              <div class="menu_hdr">
                                ...
                                <ul class="tr_1">
                                  <li><img src="{$img_path}/img/special/result/graph_group/title1.png" alt="ハッピーアクション"></li>
                                  <li><img src="{$img_path}/img/special/result/graph_group/title2.png" alt="ハッピーカラー"></li>
                                </ul>
                                <div class="clear"></div>
                                <ul class="tr_2">
                                ...
                                <ul class="tr_3">
                                  <li>
                                    <div class="tesou_sample">
                                      <img src="{$img_path}/img/special/result/graph_group/title3.png" alt="ハッピーライン"><br>
