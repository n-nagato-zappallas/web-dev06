              ...
              <div id="free_group1" class="free_group">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group/group1/section_title.jpg" alt="無料鑑定　今、注目の人気占い師が2021年下半期あなたの運勢を毎日鑑定！"></h2>
                              ...
                              <div class="menu_ftr">
                                <div class="menu_hdr">
                                  <div class="input_self">
                                    <h3><img src="{$img_path}/img/special/free_group/group1/title1.jpg" alt="あなたの情報を入力してください"></h3>
