...
{* 1人用パックメニューおすすめ枠（index、normal_allfree） *}
              ...
              <div id="pack_group1">
                <div class="text_img">
                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/pack_text1.jpg" alt="パック限定特典として　星ひとみ監修　今年の下半期の最強幸運期や開運アクションなどが分かるあなただけの特別鑑定書をお届け！">
                </div>
                <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/section_title.jpg" alt="豪華パック下半期運　2021年も折り返し地点！　TVやメディアで人気の占い師があなたの2021年下半期を総力鑑定"></h2>
                <div class="section_bdy">
                  <div class="section_ftr">
                    <div class="section_hdr">
{if $isp == '70'}
                      <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/text1.png" alt="それぞれ買うより5,940円（税込）もお得!!※"></h2>
{elseif $isp == '40'}
                      <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/text2.png" alt="それぞれ買うより5,940円（税込）もお得!!"></h2>
{else}
                      <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/text3.png" alt="それぞれ買うより6,600円（税込）もお得!!※"></h2>
{/if}
                      
                      <!-- 5人パックメニュー -->
                      <div class="pack_menu">
                        <p><a href="{$uri_path}/input/lj21_002.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="ここでしか占えない人気占い師6人が占う！　2021年下半期あなたの運勢豪華パック84章" class="swapImage"></a></p>
{if $isp == '70'}
