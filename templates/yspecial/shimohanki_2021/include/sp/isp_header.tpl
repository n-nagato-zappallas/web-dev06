...
<!-- SNS -->
  <div class="sns">
    ...
    <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://charge-fortune.yahoo.co.jp/zap/event/{$event}/index.html" data-text="星ひとみ、島田秀平、水晶玉子、シウマ、木村藤子、岡井浄幸、人気占い師6人が2021年下半期の運勢を無料で鑑定" data-hashtags="ヤフー占い,2021年下半期の運勢,無料占い">Tweet</a><script>!function(d,s,id){literal}{{/literal}var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){literal}{{/literal}js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);{literal}}}{/literal}(document, 'script', 'twitter-wjs');</script>
    <div class="line-it-button" data-lang="ja" data-type="share-a" data-url="Yahoo!占い　あなたの毎日をHAPPYに！　人気占い師が総力鑑定◆2021年下半期特集  https://charge-fortune.yahoo.co.jp/zap/event/{$event}/index.html" style="display: none;"></div>
