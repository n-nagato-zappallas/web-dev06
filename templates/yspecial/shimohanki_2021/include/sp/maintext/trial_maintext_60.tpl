...
{/section}
                      ...
                      <div class="message_group">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/main_all/message_group/hoshihitomi_zap.jpg" alt="星ひとみからのメッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="menu_bdy">
                                <div class="menu_ftr">
...
{/section}
                      ...
                      <div class="message_group">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/main_all/message_group/shiuma2_zap.jpg" alt="シウマからのメッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="menu_bdy">
                                <div class="menu_ftr">
                              ...
                              <div class="menu_ftr">
                                <div class="menu_hdr">
                                  <div class="ttl_bdy">
                                    <div class="ttl_ftr">
                                      <div class="ttl_hdr">
                                        <h5>{$okai_zap.menu_min_title[$smarty.section.i.index]}</h5>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="detail_txt">
...
{/section}
                      ...
                      <div class="message_group">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/main_all/message_group/okai_zap.jpg" alt="岡井浄幸からのメッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="menu_bdy">
                                <div class="menu_ftr">
                                  <div class="menu_hdr">
                                    <div class="ttl_bdy">
                                      <div class="ttl_ftr">
                                        <div class="ttl_hdr">
                                          <h5>{$okai_zap.menu_min_title[14]}</h5>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="detail_txt">
