...
{* 星さん特別メニュー *}
              ...
              <div id="rec_single">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/rec_single/section_title.jpg" alt="仕事や、人間関係。結婚、恋愛のこと……　あらゆる悩みをズバッと解決！　まだまだ！星ひとみ　特集{if $isp == '70'}限定{else}特別{/if}鑑定"></h2>
...
{foreach name="menu_list" from=$hoshi1 key="row_key" item="menu_list"}
                        ...
                        <div class="menu_info menu{$smarty.foreach.menu_list.index+1}" data-flag="{$menu_list.release_flag}">
                          <div class="ttl_bdy">
                            <div class="ttl_ftr">
                              <div class="ttl_hdr">
                                <img src="{$img_path}/img/special/rec_single/icon.png" alt="特集{if $isp == '70'}限定{else}厳選{/if}" class="icon_limited">
...
{elseif $isp == '40'}
                                      <p class="price_info">{if $menu_list.discount_flag == 1}<strong class="price_discount">プレミアム価格 {$menu_list.menu_discount}円（税込）</strong>&nbsp;/&nbsp;通常価格 {/if}{$menu_list.menu_price}円（税込）</p>
{else}
