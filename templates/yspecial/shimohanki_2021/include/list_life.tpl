...
{if $list_life[0]}
              ...
              <!-- 1人用総合運メニュー -->
              <div class="text_img">
                <img src="{$img_path}/img/special/result/list_group/text.jpg" alt="その他、人気占い師4人の鑑定も必見！">
              </div>
              <div class="list_group life">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/result/list_group/life/section_title.jpg" alt="2021年あなたの総合運"></h2>
...
{* 通常用 *}
              ...
              <div id="list_group1">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/list_group/life/section_title.jpg" alt="豪華占い師6人がそれぞれ占う！　2021年下半期のあなたの運勢"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
{if $list_life[0]}
                      <!-- パックメニュー個別リスト（一部無料なし） -->
...
{foreach name="menu_list" from=$list_life key="row_key" item="menu_list"}
                        ...
                        <div class="menu_ttl_bar2 menu_ttl_{$menu_list.contents}">
                          <div class="menu_bdy{if $smarty.foreach.menu_list.iteration is odd } right{else} left{/if}">
                            <div class="menu_ftr">
                              <div class="menu_hdr">
                                <div class="arrow">
