                            ...
                            <div class="article_bdy">
                              <div class="article_ftr">
                                ...
                                <table border="0" cellspacing="0">
                                  <tr>
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/1.png" alt="2023年" class="img1">
                                  ...
                                  <tr>
                                    <td>
                                      <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/group1/text_year/2.png" alt="2023年" class="img1">
...
{/if}
                        ...
                        <div class="graph_sub2" id="graph_sub2">
                          <div class="article_bdy">
                            ...
                            <div class="article_ftr">
                              <div class="article_hdr">
                                <div class="graph_bdy graph{$base_id_self} {if $year_now == '2022'}month_1{else}month_{$month_now}{/if}">
{if $year_now == '2022'}
...
{if $isp == '11'}
              <div id="topicpath">
                <p><a href="https://honkaku-uranai.jp/moon/">cocoloni占い館 Moon Top</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/">ゲッターズ飯田2023年運特集</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/input/{$menu_id}.html">{$menu_title}</a>&nbsp;&gt;&nbsp;鑑定結果</p>
              </div>
{/if}
</article>
