{* 総合運（getters1） *}
                    <div class="menu_ttl_bar2 menu_ttl_{$getters1.menu_contents}" id="child_1">
                      <div class="menu_bdy">
                        <div class="menu_ftr">
                          <div class="menu_hdr">
...
{* 仕事お金運（getters2） *}
                    <div class="menu_ttl_bar2 menu_ttl_{$getters2.menu_contents}" id="child_2">
                      <div class="menu_bdy">
                        <div class="menu_ftr">
                          <div class="menu_hdr">
                            <div class="severalmenu">
...
{* 恋愛結婚運（getters3） *}
                    <div class="menu_ttl_bar2 menu_ttl_{$getters3.menu_contents}" id="child_3">
                      <div class="menu_bdy">
                        <div class="menu_ftr">
                          <div class="menu_hdr">
                            <div class="severalmenu">
...
{* 健康家庭運（getters4） *}
                    <div class="menu_ttl_bar2 menu_ttl_{$getters4.menu_contents}" id="child_4">
                      <div class="menu_bdy">
                        <div class="menu_ftr">
                          <div class="menu_hdr">
                            <div class="severalmenu">
...
{* メッセージ *}
                    <div class="main_all_bdy">
                      <div class="message_group special">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/message_group/article_title.jpg" alt="ゲッターズ飯田からのあなたへのメッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="photo_img"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/photo4.png" alt=""></div>
