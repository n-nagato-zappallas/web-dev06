              ...
              <div id="free_group1" class="free_group">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/section_title.jpg" alt="今すぐチェック！　五星三心占いを無料で体験！あなたにとって2023年はどんな年？まずは五星三心占いであなたのタイプをチェックしてみましょう！"></h2>
