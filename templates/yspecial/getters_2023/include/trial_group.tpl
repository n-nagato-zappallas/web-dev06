...
{if $menu_id == 'gr23_001'}
                <!-- 無料1人用(gt21_001年運) -->
                <h3><img class="trial_group_h3_img" src="{$img_path}/img/special/result/navi/text.jpg" alt="個別に運勢を知りたい方はこちらから！"><br>※以下は上記パックに含まれているメニューです</h3>
{include file="include/pack_navi.tpl"}
{else}
                <h3><img src="{$img_path}/img/special/result/next_group/text1.jpg" alt="今のあなたにおすすめの2023年運勢メニュー！"></h3>
{/if}
