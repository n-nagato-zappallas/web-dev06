...
<!-- SNS -->
  <div class="sns">
    ...
    <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://charge-fortune.yahoo.co.jp/zap/event/{$event}/index.html" data-text="島田秀平、水晶玉子、星ひとみ、シウマ、木村藤子、人気占い師5人が2021年の運勢を無料で鑑定" data-hashtags="ヤフー占い,2021年の下半期の運勢,無料占い">Tweet</a><script>!function(d,s,id){literal}{{/literal}var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){literal}{{/literal}js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);{literal}}}{/literal}(document, 'script', 'twitter-wjs');</script>
    <div class="line-it-button" data-lang="ja" data-type="share-a" data-url="Yahoo!占い　2021年運勢特集◇超人気占い師5人がズラリ勢ぞろい！ 豪華コラボ鑑定  https://charge-fortune.yahoo.co.jp/zap/event/unsei_2021/index.html" style="display: none;"></div>
