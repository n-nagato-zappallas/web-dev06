...
{if $result_flag}
      <div id="footernavi">
        <ul>{strip}
          ...
          <li><a href="https://honkaku-uranai.jp/cp_zap/{$event}/">2021年年運特集 Top</a>&nbsp;</li>
          <li><span class="cp_zap_short_title">2021年年運特集</span></li>
        </ul>
        <ul>
      ...
      <div class="clear"></div>
      <p class="contents_footerCopy">人気の占いを集めた占いポータルサイト-cocoloni-本格占い館<br /><span class="cp_zap_short_title">2021年年運特集</span></p>
