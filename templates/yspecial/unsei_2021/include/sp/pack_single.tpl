...
{if $menu_design_cd == 99}
                  <div class="text_img">
                    <img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/pack_text1.jpg" alt="運勢グラフが毎月の運勢をズバッとお伝えします！2021年あなたの総合運鑑定　超豪華パックはこちら">
                  </div>
{/if}
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/section_title.jpg" alt="5人全員の総合運鑑定がわかる豪華パック！　2021年がひと目でわかる！月運グラフつき！　圧倒的な的中力で人気の占い師5人があなたの2021年の運勢を完全鑑定{if $isp == '70'}　それぞれ買うより4,900円以上もお得!!※{elseif $isp == '40'}　それぞれ買うより4,900円以上もお得!!{else}　それぞれ買うより5,500円（税込）もお得※{/if}"></h2>
...
{if !$result_flag }
                        <p><a href="{$uri_path}/input/nv21_003.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="人気占い師5人による豪華特別鑑定！「あなたの2021年運勢」豪華全網羅パック全65章" class="swapImage"></a></p>
  {if $isp == '70'}
...
{if $menu_design_cd == 99}
                        <p><input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="人気占い師5人による豪華特別鑑定！「あなたの2021年運勢」豪華全網羅パック全65章" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/nv21_003.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="人気占い師5人による豪華特別鑑定！「あなたの2021年運勢」豪華全網羅パック全65章" class="swapImage"></a></p>
{/if}
{if $isp == '70'}
