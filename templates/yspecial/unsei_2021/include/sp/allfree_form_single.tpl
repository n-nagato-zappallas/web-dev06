              ...
              <div id="free_group1">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/group1/section_title.jpg" alt="あなたの1年のテーマを表す絵馬つき！超豪華無料鑑定　2021年のあなたが丸わかり！　大人気占い師による運だめしおみくじ　メディアで大活躍の人気占い師5人が大集結！　2021年のあなたの運勢をバーチャルおみくじで占います！"></h3>
                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/group1/section_hdr.jpg" alt="シウマ　星ひとみ　島田秀平　水晶玉子　木村藤子"></h3>
                              ...
                              <div class="menu_bdy">
                                <div class="menu_ftr">
                                  <div class="menu_hdr">
                                    ...
                                    <div class="form_btn">
                                      <input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/free_group/free_button.png" alt="無料でおみくじを引く" id="free_button" onclick="checkParams( this.form );" name="free_button" class="swapImage">
                                    </div>
                                    <div class="privacy">
{if $isp == '11'}
