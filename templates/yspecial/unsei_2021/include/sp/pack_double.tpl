...
{if $menu_design_cd == 99}
                  <div class="text_img">
                    <img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/pack_text2.jpg" alt="相性グラフつきで二人の恋の行方をズバッとお伝えします！2021年あなたの恋運命鑑定　超豪華パックはこちら">
                  </div>
{/if}
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group2/section_title.jpg" alt="豪華恋愛鑑定パック！　二人の相性グラフつきで絶好のタイミングがひと目でわかる！人気占い師5人が全力で導く恋愛成就の決定版{if $isp == '70'}　それぞれ買うより4,900円以上もお得!!※{elseif $isp == '40'}　それぞれ買うより4,900円以上もお得!!{else}　それぞれ買うより5,500円（税込）もお得※{/if}"></h2>
...
{if !$result_flag || $result_flag && $menu_person == '1'}
                        <p><a href="{$uri_path}/input/nv21_004.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group2/btn.png" alt="人気占い師5人が15,000字で紡ぐ二人の恋の行方「2021年あの人との恋」豪華恋愛特別鑑定パック" class="swapImage"></a></p>
  {if $isp == '70'}
  ...
  {elseif $isp == '40'}
                        <p class="price_info">プレミアム価格　<strong class="price_discount">4,950円（税込）</strong>&nbsp;/&nbsp;
                        通常価格　<strong class="price_discount">5,500円（税込）</strong></p>
  {else}
                        <p class="price_info">5,500円（税込）</p>
  {/if}
{else}
{* 完全無料一人用結果ページ用 *}
...
{if $menu_design_cd == 99}
                        <p><input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/pack_group/group2/btn.png" alt="人気占い師5人が15,000字で紡ぐ二人の恋の行方「2021年あの人との恋」豪華恋愛特別鑑定パック" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/nv21_004.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group2/btn.png" alt="人気占い師5人が15,000字で紡ぐ二人の恋の行方「2021年あの人との恋」豪華恋愛特別鑑定パック" class="swapImage"></a></p>
{/if}
{if $isp == '70'}
