              ...
              <div id="free_group2">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group/group2/section_title.jpg" alt="あなたの1年のテーマを表す絵馬つき！二人の恋無料鑑定　2021年の2人の恋の行方は？　あなたとあの人のバーチャル恋みくじ"></h2>
                    <h2><img src="{$img_path}/img/special/free_group/group2/section_hdr.jpg" alt="シウマ　星ひとみ　島田秀平　水晶玉子　木村藤子"></h2>
                    <h2><img src="{$img_path}/img/special/free_group/group2/section_hdr_self.jpg" alt="あなたの情報を入力してください"></h2>
