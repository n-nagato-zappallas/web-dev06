...
{if $result_flag}
      <div id="footernavi">
        <ul>{strip}
          ...
          <li>|&nbsp;<a href="https://honkaku-uranai.jp/cp_zap/{$event}/">2021年運勢特集 Top</a>&nbsp;</li>
          <li>|&nbsp;<a href="https://honkaku-uranai.jp/sitemap/">サイトマップ</a>&nbsp;|</li>
        {/strip}</ul>
      </div>
      <div class="clear"></div>
      <p class="contents_footerCopy">人気の占いを集めた占いポータルサイト-cocoloni-本格占い館｜<span class="cp_zap_short_title">2021年運勢特集</span></p>
