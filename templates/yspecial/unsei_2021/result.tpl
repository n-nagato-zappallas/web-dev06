...
{if $menu_person == '1'}
                    <h2><img src="{$img_path}/img/special/result/graph_group/single/section_title.jpg" alt="人気占い師5人が占う！　2021年あなたの運勢グラフ"></h2>
{else}
                    <h2><img src="{$img_path}/img/special/result/graph_group/double/section_title.jpg" alt="人気占い師5人が占う！　2021年二人の相性グラフ"></h2>
{/if}
...
{/section}
                                ...
                                <div class="result_bg">
                                  <div class="graph_legend">
                                    <ul>
                                      <li><img src="{$img_path}/img/special/result/graph_group/img1.png" alt="島田秀平"></li>
                                      <li><img src="{$img_path}/img/special/result/graph_group/img2.png" alt="水晶玉子"></li>
                                      <li><img src="{$img_path}/img/special/result/graph_group/img3.png" alt="星ひとみ"></li>
                                      <li><img src="{$img_path}/img/special/result/graph_group/img4.png" alt="シウマ"></li>
                                      <li><img src="{$img_path}/img/special/result/graph_group/img5.png" alt="木村藤子"></li>
                                    </ul>
                                    <div class="clear"></div>
{if $isp == '70'}
<!--
                                    <p>※運勢グラフの結果は、5人の監修者毎に毎月の吉凶のポイントを合算し、合算値の低い月を注意すべき月としています。<br>
2021年を通しての結果では無く毎月の結果となるため、良い月としている監修者がいても注意すべき月となることがあります。</p>
-->
{/if}
                                  </div>
                                    ...
                                    <div class="menu_ftr">
                                      <div class="menu_hdr">
                                        <div class="severalmenu">
                                          <h4><img src="{$img_path}/img/special/result/graph_group/{if $menu_person == '1'}single{else}double{/if}/subtitle1.png" alt="{if $menu_person == '2'}相性{/if}運勢が一番良い月"></h4>
                                          <p>{$graph_max_txt}</p>
                                          <h4><img src="{$img_path}/img/special/result/graph_group/{if $menu_person == '1'}single{else}double{/if}/subtitle2.png" alt="{if $menu_person == '1'}一番注意しなければならない月{else}一番すれ違いがおきやすい月{/if}"></h4>
                                          <p>{$graph_min_txt}</p>
                                        </div>
                                      </div>
                                    </div>
                        ...
                        <div class="pack_navi">
                          <ul>
                            ...
                            <li><a href="#child_3"><img src="{$img_path}/img/special/result/graph_group/navi/hoshihitomi_zap.png" alt="星ひとみ"></a></li>
                            <li><a href="#child_4"><img src="{$img_path}/img/special/result/graph_group/navi/shiuma2_zap.png" alt="シウマ"></a></li>
                            <li><a href="#child_5"><img src="{$img_path}/img/special/result/graph_group/navi/fujiko_ccs.png" alt="木村藤子"></a></li>
                          </ul>
                          <div class="clear"></div>
                        </div>
                      </div>
