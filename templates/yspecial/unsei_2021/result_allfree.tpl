...
{if $menu_person == '1'}
                    <h2 id="point_title2"><img src="{$img_path}/img/special/result/point_group/single/section_title.jpg" alt="2021年の運だめし！あなたの結果は……"></h2>
{else}
                    <h2 id="point_title2"><img src="{$img_path}/img/special/result/point_group/double/section_title.jpg" alt="2021年の二人の恋みくじ！気になるあの人との相性は……"></h2>
{/if}
...
{/if}
                                ...
                                <div id="point_graph" class="{if $menu_person == '1'}bg_single{else}bg_double{/if}">
                                  ...
                                  <div id="omikuji_text">
                                    <p id="item_1" class="cd{$free_kuji_cd}"><img src="{$img_path}/img/special/result/point_group/{$free_kuji_cd}.png" alt="運勢　{$free_kuji_word}"></p>
                                    <div id="item_2">
                                      <ul>
...
{if $menu_person == '1'}
                          <h3><img src="{$img_path}/img/special/result/summary_group/single/menu_title.jpg" alt="5人がそれぞれちょっとずつ占います！　2021年あなたの運勢"></h3>
{else}
                          <h3><img src="{$img_path}/img/special/result/summary_group/double/menu_title.jpg" alt="5人がそれぞれちょっとずつ占います！　2021年のあの人との恋"></h3>
{/if}
