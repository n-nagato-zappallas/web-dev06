        ...
        <div id="basebdy">
          ...
          <div id="contents">
            <div id="contents_inner">
              <div id="topicpath">
{if $isp == '11'}
                <p><a href="https://honkaku-uranai.jp/">本格占い館 Top</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/">2021年運勢特集</a>&nbsp;&gt;&nbsp;{$menu_title}&nbsp;&gt;&nbsp;一部無料鑑定結果</p>
{else}
...
{/if}
                                  ...
                                  <div class="menu_bdy">
                                    <div class="menu_ftr">
                                      <div class="menu_hdr">
                                        <div class="mosaic">
                                          <img src="{$img_path}/img/special/result/trial/text.png" alt="有料版では2021年の一番良い月の運勢と注意すべき月の運勢が表示されます">
                                        </div>
                                        <div class="clear"></div>
                                      </div>
                                    </div>
