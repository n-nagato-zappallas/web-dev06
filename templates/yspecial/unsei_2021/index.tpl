...
{/if}
          <div id="header_nav">
            <ul>
              <li><a href="#free_group1" ><img src="{$img_path}/img/special/navi/navi01.png" alt="おみくじ　完全無料　運だめしおみくじ" class="swapImage"></a></li>
              <li><a href="#free_group2" ><img src="{$img_path}/img/special/navi/navi02.png" alt="恋みくじ　完全無料　二人を占う恋みくじ" class="swapImage"></a></li>
            </ul>
            <div class="clear"></div>
          </div>
            ...
            <div id="contents_inner">
              ...
              <div id="new_group">
                <div class="banner_group" style="margin-top:20px;">
                  <p><a href="#month_group1"><img src="./img/special/new_group/banner5_pc.png" alt="「転機は訪れる？」今月のあなたを待ち受ける運命は？『2021年月のあなたの運勢』メニューを追加"></a></p>
                </div>
              </div>
              -->
              <!-- //お知らせ -->
