...
{if $menu_person == '1'}
                    <h2 id="point_title2"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/single/section_title.jpg" alt="TVで大活躍の人気占い師6人が大集結！あなたの2023年運勢鑑定書"></h2>
{else}
                    <h2 id="point_title2"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/double/section_title.jpg" alt="2023年の二人の相性は……？あなたとあの人の恋鑑定書"></h2>
{/if}
...
{if $menu_person == '1'}
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/single/category1.png" alt="恋愛"></th>
                                      <td><p>{$free_kuji_unsei1}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/single/category2.png" alt="対人"></th>
                                      <td><p>{$free_kuji_unsei2}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/single/category3.png" alt="仕事"></th>
                                      <td><p>{$free_kuji_unsei3}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/single/category4.png" alt="レジャー"></th>
                                      <td><p>{$free_kuji_unsei4}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/single/category5.png" alt="ご縁"></th>
                                      <td><p>{$free_kuji_unsei5}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/single/category6.png" alt="お金"></th>
                                      <td><p>{$free_kuji_unsei6}</p></td>
                                    </tr>
{else}
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/double/category1.png" alt="積極性"></th>
                                      <td><p>{$free_kuji_unsei1}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/double/category2.png" alt="変化"></th>
                                      <td><p>{$free_kuji_unsei2}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/double/category3.png" alt="余裕"></th>
                                      <td><p>{$free_kuji_unsei3}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/double/category4.png" alt="信頼"></th>
                                      <td><p>{$free_kuji_unsei4}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/double/category5.png" alt="愛情"></th>
                                      <td><p>{$free_kuji_unsei5}</p></td>
                                    </tr>
                                    <tr>
                                      <th><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/point_group/double/category6.png" alt="欲望"></th>
                                      <td><p>{$free_kuji_unsei6}</p></td>
                                    </tr>
{/if}
                                  </table>
...
{if $menu_person == '1'}
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/summary_group/single/menu_title.jpg" alt="6人がそれぞれちょっとずつ占います！　2023年あなたの運勢"></h3>
{else}
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/summary_group/double/menu_title.jpg" alt="6人がそれぞれちょっとずつ占います！　2023年のあの人との恋"></h3>
{/if}
