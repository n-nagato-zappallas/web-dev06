  ...
  <main>
          <div id="contents">
            <div id="contents_inner">
              <div id="topicpath">
{if $isp != '11'}
                <p><a href="{$uri_path}/">特集トップ</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/input/{$menu_id}.html">{$menu_title}</a>&nbsp;&gt;&nbsp;一部無料鑑定結果</p>
{/if}
              </div>
...
{/section}
                                ...
                                <div class="result_bg">
                                  <div class="graph_legend">
                                    <ul>
                                      <li><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/graph_group/img.png" alt="星ひとみ　木下レオン　シウマ　大串ノリコ　ぷりあでぃす玲奈　村野弘味"></li>
                                    </ul>
                                    <div class="clear"></div>
{if $isp == '70'}
<!--
                                  ...
                                  <div class="menu_bdy">
                                    <div class="menu_ftr">
                                      <div class="menu_hdr">
                                        <div class="mosaic">
{if $menu_person == '1'}
                                          <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/trial/text1.png" alt="有料版では2023年の一番良い月の運勢と一番注意しなければならない月の運勢が表示されます">
{else}
                                          <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/trial/text2.png" alt="有料版では2023年の一番良い月の運勢と一番すれ違いやすい月の運勢が表示されます">
{/if}
                                        </div>
                                      </div>
                                    </div>
...
{if $isp == '11'}
              <div id="topicpath">
                <p><a href="https://honkaku-uranai.jp/moon/">cocoloni占い館 Moon Top</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/">2023年運勢特集</a>&nbsp;&gt;&nbsp;<a href="{$uri_path}/input/{$menu_id}.html">{$menu_title}</a>&nbsp;&gt;&nbsp;一部無料鑑定結果</p>
              </div>
{/if}
</article>
