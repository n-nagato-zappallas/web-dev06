              ...
              <div id="free_group1">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/group1/section_title.jpg" alt="超豪華無料鑑定　2023年のあなたの運勢が丸分かり！　大人気占い師による『運勢鑑定書』　あのテレビ番組で大活躍中の人気占い師6人が大集結！　2023年のあなたの運勢を総力を結集し豪華に占います！"></h3>
                        ...
                        <div id="inputForm">
                          ...
                          <div id="frmInput" style="display: none;">
                            <div class="input_self">
                                ...
                                <tbody>
                                  ...
                                  <tr class="tr_birthplace">
                                    <th class="ttl_font" colspan="2">
                                      <label for="birth_place_self">出生地</label>
                              ...
                              <div class="form_btn">
                                <input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/free_group/free_button.png" alt="運勢鑑定書を無料で受けとる" id="free_button" onclick="checkParams( this.form );" name="free_button" class="swapImage">
                              </div>
                              <div class="privacy">
{if $isp == '11'}
