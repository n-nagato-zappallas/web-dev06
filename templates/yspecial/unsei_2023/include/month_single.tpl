...
{if $month_list && $month_list.single && $month_list.single.0}
              ...
              <div id="month_group1" class="month_group">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/month_group/section_title_{$release_month}.jpg" alt="月運　「何が起こる？」「どう乗りきる?」今月のあなたを占ってもいいですか？　毎月更新！　あなたの月運を今すぐチェック！{if $release_month|substr:4:1 == 0}{$release_month|substr:0:4}年{$release_month|substr:5:1}月{else}{$release_month|substr:0:4}年{$release_month|substr:4:2}月{/if}のあなたの運勢"></h2>
