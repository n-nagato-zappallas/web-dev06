              ...
              <div id="free_group2">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group/group2/section_title.jpg" alt="二人の恋無料鑑定　2023年の二人の恋の行方は？　あなたとあの人の『恋鑑定書』"></h2>
                              ...
                              <div class="menu_ftr">
                                <div class="menu_hdr">
                                    ...
                                    <table class="input_tbl input_tbl_1" cellspacing="0">
                                      <tbody>
                                        ...
                                        <tr class="tr_birthtime">
                                          ...
                                          <td>
                                            <select id="birth_hour_self2" name="birth_hour_self" class="select_hour"></select><label for="birth_hour_self2" onclick="return clickFormLabel(this)">時</label><select id="birth_min_self2" name="birth_min_self" class="select_min"></select><label for="birth_min_self2" onclick="return clickFormLabel(this)">分</label>
                                          </td>
                                        </tr>
                                        <tr class="tr_caution">
                                          <th></th>
                                  ...
                                  <div class="input_other">
                                    ...
                                    <table class="input_tbl input_tbl_1" cellspacing="0">
                                      <tbody>
                                        ...
                                        <tr class="tr_birthday">
                                          <th><label>出生時間</label></th>
                                          <td>
                                            <select id="birth_hour_other2" name="birth_hour_other" class="select_hour"></select><label for="birth_hour_other2" onclick="return clickFormLabel(this)">時</label><select id="birth_min_other2" name="birth_min_other" class="select_min"></select><label for="birth_min_other2" onclick="return clickFormLabel(this)">分</label>
                                          </td>
                                        </tr>
                                        <tr class="tr_caution">
                                          <th></th>
                                    ...
                                    <div class="form_btn">
                                      <input type="image" src="{$img_path}/img/special/free_group/free_button2.png" alt="恋鑑定書を無料で受けとる" id="free_button2" onclick="checkParams( this.form );" name="free_button2" class="swapImage">
                                    </div>
                                    <div class="privacy">
{if $isp == '11'}
