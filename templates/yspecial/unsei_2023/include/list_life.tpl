...
{if $list_life[0]}
              ...
              <div class="list_group life">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/result/list_group/life/section_title.jpg" alt="2023年あなたの総合運"></h2>
...
{* 通常用 *}
              ...
              <div id="list_group1">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/list_group/life/section_title.jpg" alt="総合運　最強占い師6人がそれぞれ占う！　2023年のあなたの総合運"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
{if $list_life[0]}
                      <!-- パックメニュー個別リスト（一部無料なし） -->
