...
{if $list_extra}
              ...
              <div class="rec_double" id="extra_group">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/rec_double/section_title.jpg" alt="まだまだあります！　今話題の人気占い師が占う　あなたの2023年の運勢"></h2>
...
{/if}
                                    ...
                                    <div class="menu_ttl">
                                      <h4><a href="{$item_list.menu_url}" target="_contents"{if $isp == '11'} onclick="traing_tokushuu('unsei_2023','{$item_list.img_name}')"{/if}>{$item_list.menu_title}</a></h4>
                                    </div>
                                    <div class="clear"></div>
