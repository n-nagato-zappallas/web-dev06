...
{if $result_flag}
      <div id="footernavi">
        <ul>{strip}
          ...
          <li>|&nbsp;<a href="https://honkaku-uranai.jp/cp_zap/{$event}/">2023年運勢特集 Top</a>&nbsp;</li>
          <li>|&nbsp;<a href="https://honkaku-uranai.jp/sitemap/">サイトマップ</a>&nbsp;|</li>
        {/strip}</ul>
      </div>
      <div class="clear"></div>
      <p class="contents_footerCopy">人気の占いを集めた占いポータルサイトcocoloni占い館 Moon｜<span class="cp_zap_short_title">2023年運勢特集</span></p>
