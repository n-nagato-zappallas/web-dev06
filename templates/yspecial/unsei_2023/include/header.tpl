...
{/if}
    ...
    <meta name="Description" content="{if $isp !="70"}{$menu_caption|strip_tags:false}{else}{$meta_description}{/if}">
{if !$result_flag}
{if $isp == '10'}
...
{/if}
{if $isp =="11"}
    <meta property="og:title" content="{$menu_title} | cocoloni占い館 Moon">
...
{/if}
{if $isp == '11'}
<base href="http://web-dev.ura.pga.jp/cp_zap/event/{$event}/" />
{/if}
<!--- /SMARTY TEMPLATE テンプレート確認用のタグです削除してください --->
{/if}
{if !$result_flag}
