...
2023年を通しての結果では無く毎月の結果となるため、良い月としている監修者がいても注意すべき月となることがあります。</p>
-->
{/if}
                                  </div>
                                  ...
                                  <div class="menu_bdy">
                                    <div class="menu_ftr">
                                      <div class="menu_hdr">
                                        <div class="mosaic">
{if $menu_person == '1'}
                                          <img src="{$img_path}/img/special/result/trial/text1.png" alt="有料版では2023年の一番良い月の運勢と一番注意しなければならない月の運勢が表示されます">
{else}
                                          <img src="{$img_path}/img/special/result/trial/text2.png" alt="有料版では2023年の一番良い月の運勢と一番すれ違いやすい月の運勢が表示されます">
{/if}
                                        </div>
                                        <div class="clear"></div>
                                      </div>
