...
{/literal}
  <div class="sns">
    ...
    <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://charge-fortune.yahoo.co.jp/zap/event/{$event}/index.html" data-text="芸能界最強占い師ゲッターズ飯田があなたの2021年を丸ごと大鑑定！" data-hashtags="ヤフー占い,ゲッターズ飯田,無料占い">Tweet</a><script>!function(d,s,id){literal}{{/literal}var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){literal}{{/literal}js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);{literal}}}{/literal}(document, 'script', 'twitter-wjs');</script>
    <div class="line-it-button" data-lang="ja" data-type="share-a" data-url="Yahoo!占い　ゲッターズ飯田があなたの2021年を徹底鑑定◆五星三心占い運勢特集  https://charge-fortune.yahoo.co.jp/zap/event/{$event}/index.html" style="display: none;"></div>
