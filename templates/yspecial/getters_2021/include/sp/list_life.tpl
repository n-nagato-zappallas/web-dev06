...
{* 通常用 *}
              ...
              <div id="list_group1">
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/list_group/section_title.jpg" alt="厳選！個別に運勢を知りたい方はこちら↓「２０２１年は全体的にどんな年になる？」「今年は転職に向いてる？　給料UPする？」「良いご縁ってある？　今年の恋愛傾向は？」「来年はどんな生活リズムで過ごすべき？」　２０２１年あなたの総合運・仕事運・恋愛運・健康運をそれぞれ大予言！"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
{if $list_life[0]}
                      <!-- パックメニュー個別リスト（一部無料なし） -->
