              ...
              <div id="free_group1" class="free_group">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/section_title.jpg" alt="特集限定無料一人用　ゲッターズ飯田の「五星三心」で占うあなたの2021年の運勢・完全無料版！己を知ることから人生ははじまる。6万人以上を無償で占った統計にもとづく、「五星三心占い」であなたの運勢を無料で占います！"></h2>
