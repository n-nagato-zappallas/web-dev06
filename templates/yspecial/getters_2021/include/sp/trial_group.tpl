...
{if $menu_id == 'gt21_001'}
                <!-- 無料1人用(gt21_001年運) -->
                <h3 class="menu_ttl"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/navi/text.jpg" alt="個別に運勢を知りたい方はこちら"></h3>
                <p class="navi_text ttl_font">以下は上記パックに含まれているメニューです</p>
{include file="include/sp/pack_navi.tpl"}
{else}
                <h3 class="menu_ttl"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/next_group/text1.jpg" alt="今のあなたにおすすめの2021年運勢メニュー！"></h3>
{/if}
