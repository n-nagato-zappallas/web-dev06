...
{if $isp == '70'}
              <p class="form_link" style="position:relative;bottom:-30px;z-index:2;text-align:center;">※一週間の運勢は2021年1月31日まで</a></p>
{/if}
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group2/section_title.jpg" alt="特集限定無料週運　五星三心占いで一週間の運勢をチェック！今週のあなたの運気はいい？ 悪い？自分の運気を知り、一週間をどんな風に過ごすか、日々の生活や行動の指針にしてください。"></h2>
