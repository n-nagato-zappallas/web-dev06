...
{if $result_flag }
                  <h2><img src="{$img_path}/img/special/result/pack_group/section_title.jpg" alt="総合運　仕事運　恋愛運　健康運　開運できる！超豪華“丸ごと”鑑定パック　“芸能界最強”ゲッターズ飯田があなたの2021年を丸ごと占います！開運3か条・月運グラフ＆12年周期グラフ付き！"></h2>
{else}
                  <h2><img src="{$img_path}/img/special/pack_group/section_title.jpg" alt="イチ押し！もっと本格的に占いたいあなたへ！総合運　仕事運　恋愛運　健康運　開運できる！超豪華“丸ごと”鑑定パック　“芸能界最強”ゲッターズ飯田があなたの2021年を丸ごと占います！開運3か条・月運グラフ＆12年周期グラフ付き！{if $isp == '70'}　それぞれ買うより800円以上お得！※{else}　それぞれ買うより880円（税込）お得！※{/if}"></h2>
{/if}
...
{if !$result_flag }
                        <div><a href="{$uri_path}/input/gt21_003.html"><img src="{$img_path}/img/special/pack_group/btn.png" alt="「2021年あなたの3大運命」恋/仕事/総合◆豪華DXパック" class="swapImage"></a></div>
{if $isp == '70'}
...
{else}
                        ...
                        <h2><img src="{$img_path}/img/special/result/pack_group/img1.png" alt="{if $isp == '70'}それぞれ買うより800円以上お得！※{else}　それぞれ買うより880円（税込）お得！※{/if}"></h2>
{if $menu_design_cd == 99}
                        <p><input type="image" src="{$img_path}/img/special/pack_group/btn.png" alt="「2021年あなたの3大運命」恋/仕事/総合◆豪華DXパック" onclick="this.form.submit();" name="btn" class="swapImage"></p>
{else}
                        <p><a href="{$uri_path}/input/gt21_003.html"><img src="{$img_path}/img/special/pack_group/btn.png" alt="「2021年あなたの3大運命」恋/仕事/総合◆豪華DXパック" class="swapImage"></a></p>
{/if}
{if $isp == '70'}
                        <p class="price_info ttl_font">会員価格{literal}　<strong class="price_discount">{YJPRICE_1425}</strong>{/literal}&nbsp;/&nbsp;
                        通常価格{literal}　<strong class="price_discount">{YJPRICE_1500}</strong>{/literal}</p>
