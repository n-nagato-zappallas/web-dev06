...
{/if}
{if $isp =="11"}
    <meta property="og:title" content="{$menu_title}　|　-cocoloni-本格占い館">
...
{/if}
{if $isp =="11"}
    <link rel="canonical" href="https://honkaku-uranai.jp/cp_zap/event/{$event}/input/{$menu_id}.html">
    <link rel="alternate" media="only screen and (max-width: 640px)" href="https://honkaku-uranai.jp/sp/cp_zap/event/{$event}/input/{$menu_id}.html" />
{/if}
</head>
