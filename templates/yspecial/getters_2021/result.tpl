                            ...
                            <div class="article_bdy">
                              <div class="article_ftr">
                                ...
                                <table border="0" cellspacing="0">
                                  <tr class="left">
                                    <td>
                                      <img src="{$img_path}/img/special/result/graph_group/group1/text_year/1.png" alt="2021年" class="img1">
...
{/if}
                        ...
                        <div class="graph_sub2" id="graph_sub2">
                          <div class="article_bdy">
                            ...
                            <div class="article_ftr">
                              <div class="article_hdr">
                                <div class="graph_bdy graph{$base_id_self} {if $year_now == '2020'}month_1{else}month_{$month_now}{/if}">
{if $year_now == '2020'}
