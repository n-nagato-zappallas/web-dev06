...
<div class="motice_mark_a" style="background-color: #C06D5F;">
  <p style="color: #fff;font-size: 0.7em;text-align: left;padding: 5px;line-height: 1.3;">本ページに記載している文言は鑑定結果の一例で、効果を保証または確約するものではございません。</p>
</div>
{/if}
