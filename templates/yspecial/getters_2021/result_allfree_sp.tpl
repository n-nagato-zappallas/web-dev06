...
{if $menu_id == 'gt21_001'}
                ...
                <div class="result_basic">
                  <div class="section_bdy">
                    <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/free_group/group1/section_title.jpg" alt="特集限定無料一人用　あなたの2021年の運勢　完全無料版！"></h2>
                    <div class="section_ftr">
                      <div class="section_hdr">
                        ...
                        <div class="signature"><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/free_group/group1/signature.png" alt="{$unki_alt}"></div>
...
{else}
                ...
                <div class="result_weekly">
                  <div class="section_bdy">
                    <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/free_group/group2/section_title.jpg" alt="特集限定無料週運　五星三心占いで一週間の運勢をチェック！"></h2>
                    <div class="section_ftr">
                      <div class="section_hdr">
                        <div class="basic_sub1">
                          <div class="severalmenu">
