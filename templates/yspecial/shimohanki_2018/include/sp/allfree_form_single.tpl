              ...
              <div id="free_group1">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img width="100%" height="auto" src="{$uri_path}/img_sp/special/free_group/group1/section_title.jpg" alt="豪華無料鑑定　一人用　2018年下半期が一目瞭然！　あなたの運勢が無料でまるわかり！"></h2>
                    <div class="section_ftr">
                      <div class="section_hdr">
                        ...
                        <input type="hidden" name="channel"  value="52a022">
                        <input type="hidden" name="event" value="{$event}">
                        <input type="hidden" name="menu_id" value="sh2018_9001">
                                ...
                                <div class="menu_ftr">
                                  <div class="menu_hdr">
                                    ...
                                    <table class="input_tbl input_tbl_1" cellspacing="0">
                                      <tbody>
                                        <tr class="tr_name">
                                          <th><label for="name_self"><img width="100%" height="auto" src="{$uri_path}/img_sp/special/free_group/frm_txt_name.png" alt="お名前"></label></th>
                                          <td>
                                        ...
                                        <tr class="tr_birthday">
                                          <th><img width="100%" height="auto" src="{$uri_path}/img_sp/special/free_group/frm_txt_date.png" alt="生年月日"></th>
                                          <td>
                                        ...
                                        <tr class="tr_sex">
                                          <th><label for="sex_self"><img width="100%" height="auto" src="{$uri_path}/img_sp/special/free_group/frm_txt_sex.png" alt="性別"></label></th>
                                          <td>
                                    ...
                                    <div class="form_btn">
                                      <input width="100%" height="auto" type="image" src="{$uri_path}/img_sp/special/free_group/free_button.png" alt="2018年下半期の運勢を無料で占う" id="free_button" onclick="checkParams( this.form );" name="free_button" class="swapImage">
                                    </div>
                                    <div class="privacy">
