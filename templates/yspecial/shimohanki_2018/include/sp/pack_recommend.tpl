                ...
                <div class="section_bdy">
                  <div class="section_ftr">
                    <div class="section_hdr">
                      ...
                      <div class="pack_menu">
{if $menu_person == '1'}
                        <h2><img width="100%" height="auto" src="{$uri_path}/img_sp/special/result/recommend_group/single/subtitle1.png" alt="あの人との恋　気になるあの人との恋がどうなるか、必見！「2018年下半期の二人の恋と運命」"></h2>
{else}
                        <h2><img width="100%" height="auto" src="{$uri_path}/img_sp/special/result/recommend_group/double/subtitle1.png" alt="総合運　仕事や金運は？　あなたの運勢はどうなる？「2018年下半期のあなたの総合運」"></h2>
{/if}
                        <a href="{$uri_path}/input/{$menu_other.menu_id}.html"><img width="100%" height="auto" src="{$uri_path}/img_sp/special/pack_group/title/{$menu_other.menu_id}.png" alt="{$menu_other.menu_title}"></a>
                      </div>
                    </div>
                  </div>
                </div>
...
{if $year_list.single[0]}
                      <!-- パックメニュー個別リスト -->
                      <h2><img width="100%" height="auto" src="{$uri_path}/img_sp/special/result/recommend_group/single/subtitle2.png" alt="総合運　その他、4人の鑑定も必見！「2018年下半期のあなたの総合運」"></h2>
...
{if $year_list.double[0]}
                      <!-- パックメニュー個別リスト -->
                      <h2><img width="100%" height="auto" src="{$uri_path}/img_sp/special/result/recommend_group/double/subtitle2.png" alt="あの人との恋　その他、4人の鑑定も必見！「2018年下半期の二人の恋と運命」"></h2>
