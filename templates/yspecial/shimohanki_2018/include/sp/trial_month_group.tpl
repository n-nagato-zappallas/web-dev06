...
{if $menu_person == '1'}
              ...
              <div id="trial_month_group">
                <div class="navi_text">
                  <p>まだまだあります！　<span class="color1">恋、仕事……人生</span>。<br>人気鑑定士が占う<br><span class="color2">{$release_month|substr:0:4}年{if $release_month|substr:4:1 == '0'}{$release_month|substr:5:1}{else}{$release_month|substr:4:2}{/if}月の運勢</span>をチェック！</p>
                </div>
                          ...
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.single[0].contents_id}.png" alt="">
                                <h2>{$month_list.single[0].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="menu_ttl_bar2 menu_ttl_{$month_list.single[1].contents_id}">
                        <div class="menu_bdy">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.single[1].contents_id}.png" alt="">
                                <h2>{$month_list.single[1].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="menu_ttl_bar2 menu_ttl_{$month_list.single[2].contents_id}">
                        <div class="menu_bdy">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.single[2].contents_id}.png" alt="">
                                <h2>{$month_list.single[2].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="menu_ttl_bar2 menu_ttl_{$month_list.single[3].contents_id}">
                        <div class="menu_bdy">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.single[3].contents_id}.png" alt="">
                                <h2>{$month_list.single[3].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="menu_ttl_bar2 menu_ttl_{$month_list.single[4].contents_id}">
                        <div class="menu_bdy">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.single[4].contents_id}.png" alt="">
                                <h2>{$month_list.single[4].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
...
{else}
              ...
              <div id="trial_month_group">
                <div class="navi_text">
                  <p>まだまだあります！　<span class="color1">二人の恋の行方は？</span><br>人気鑑定士が占う<br><span class="color2">{$release_month|substr:0:4}年{if $release_month|substr:4:1 == '0'}{$release_month|substr:5:1}{else}{$release_month|substr:4:2}{/if}月</span>の<span class="color1">あの人との恋</span></p>
                </div>
                      ...
                      <div class="menu_ttl_bar2 menu_ttl_{$month_list.double[0].contents_id}">
                        <div class="menu_bdy">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.double[0].contents_id}.png" alt="">
                                <h2>{$month_list.double[0].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="menu_ttl_bar2 menu_ttl_{$month_list.double[1].contents_id}">
                        <div class="menu_bdy">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.double[1].contents_id}.png" alt="">
                                <h2>{$month_list.double[1].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="menu_ttl_bar2 menu_ttl_{$month_list.double[2].contents_id}">
                        <div class="menu_bdy">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.double[2].contents_id}.png" alt="">
                                <h2>{$month_list.double[2].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="menu_ttl_bar2 menu_ttl_{$month_list.double[3].contents_id}">
                        <div class="menu_bdy">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.double[3].contents_id}.png" alt="">
                                <h2>{$month_list.double[3].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="menu_ttl_bar2 menu_ttl_{$month_list.double[4].contents_id}">
                        <div class="menu_bdy">
                          <div class="menu_ftr">
                            <div class="menu_hdr">
                              <div class="severalmenu">
                                <img width="100%" height="auto" src="{$uri_path}/img_sp/special/contents/icon/{$month_list.double[4].contents_id}.png" alt="">
                                <h2>{$month_list.double[4].menu_title}</h2>
                                <div class="clear"></div>
                              </div>
                            </div>
                          </div>
