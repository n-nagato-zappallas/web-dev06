              ...
              <div id="trial_group" style="margin-bottom:30px;">
                <div class="navi_text">
                  <h3><img src="{$uri_path}/img/special/result/navi/text2.png" alt="5人それぞれの鑑定は単品でもご利用頂けます"></h3>
                  <p>以下は上記パックに含まれているメニューです<br>※鑑定士画像をクリックすると単品メニューまで移動します</p>
                </div>
                <div class="pack_navi">
                  <ul>
                ...
                <div class="text_img">
{if $menu_person == '2'}
                  <img src="{$uri_path}/img/special/result/trial_group/text.jpg" alt="あの人との恋　豪華占師5人がそれぞれ占う！「2018年下半期の二人の恋と運命」">
{/if}
                </div>
