...
{if $month_list.double.0}
              ...
              <div id="month_group2" class="month_group">
                <div class="section_bdy">
                  <h2><img src="{$uri_path}/img/special/month_group/group2/section_title_{$release_month}.jpg" alt="月運二人用　「今の気持ちは？」「進展はある？」二人の恋の行方は――？　毎月更新！　今月の運勢を今すぐチェック！　「{if $release_month|substr:4:1 == 0}{$release_month|substr:0:4}年{$release_month|substr:5:1}月{else}{$release_month|substr:0:4}年{$release_month|substr:4:2}月{/if}のあの人との恋」"></h2>
