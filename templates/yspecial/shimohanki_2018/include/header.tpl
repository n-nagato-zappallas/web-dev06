...
{if $result_flag && ( $menu_design_cd == '40' || $menu_design_cd == '99' )}
    <script type="text/javascript" src="{$uri_path}/js/{$event}.js"></script>
{/if}
    ...
    <link rel="stylesheet" type="text/css" href="{$uri_path}/css/special.css{if !$result_flag}?ver=20180625i{/if}">
