...
<!-- beginning -->
  <div id="index_header">
    <h1 title="{$special_title}"><img width="100%" height="auto" src="./img_sp/special/header_index.jpg" alt="{$special_title}"></h1>
  </div>
...
{if $release_date >= '20180625'}
              <div id="new_group">
                <div class="banner_group">
                  <p><a href="#month_group1"><img width="100%" height="auto" src="./img_sp/special/new_group/banner10.png" alt="「毎月ツイてる？」あなたを待ち受ける運命は？「2018年11月のあなたの運勢」メニューを更新"></a></p>
                  <p><a href="#month_group2"><img width="100%" height="auto" src="./img_sp/special/new_group/banner11.png" alt="「今の気持ちは？」二人の恋の行方は―？「2018年11月のあなたとあの人との恋」メニューを更新"></a></p>
                  <p><a href="#pickup_group"><img width="100%" height="auto" src="./img_sp/special/new_group/banner12.png" alt="下半期特集連動企画！　島田秀平と鏡リュウジが特別鑑定『この先何が起こる～仕事＆恋の転機』メニューを更新"></a></p>
                </div>
              </div>
              <!-- //お知らせ -->
{/if}
        ...
        <section id="attention">
          <h3><img width="100%" height="auto" src="./img_sp/special/attention.png" alt="注意事項"></h3>
