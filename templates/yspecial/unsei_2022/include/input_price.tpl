...
{if $isp == '11' && $menu_id == 'nw22_061' }
                                <p style="line-height:1.5em;"><strong style="color:#A90C0C;">リニューアル記念★期間限定　無料会員の方は0円でご利用いただけます。</strong><br><strong>期間：2022年8月24日まで　{$menu_price} → </strong><strong style="color:#A90C0C;">0円</strong></p>
{else}
