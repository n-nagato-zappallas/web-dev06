              ...
              <div id="free_group1">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group/group1/section_title.jpg" alt="超豪華無料鑑定　2022年のあなたの運勢が丸分かり！　大人気占い師による運だめしくじ　メディアで大活躍の人気占い師6人が大集結！　2022年のあなたの運勢を運だめしくじで豪華に占います！"></h2>
                              ...
                              <div class="menu_ftr">
                                <div class="menu_hdr">
                                  <div class="input_self">
                                    <h3><img src="{$img_path}/img/special/free_group/group1/section_hdr_self.jpg" alt="あなたの情報を入力してください"></h3>
                                    ...
                                    <div class="form_btn">
                                      <input type="image" src="{$img_path}/img/special/free_group/free_button.png" alt="無料で運だめしくじを引く" id="free_button" onclick="checkParams( this.form );" name="free_button" class="swapImage">
                                    </div>
                                    <div class="privacy">
{if $isp == '11'}
