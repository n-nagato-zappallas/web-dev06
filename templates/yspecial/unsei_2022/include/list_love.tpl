...
{if $list_love[0]}
              ...
              <div class="list_group love">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/result/list_group/love/section_title.jpg" alt="2022年二人の恋愛成就鑑定"></h2>
...
{* 通常用 *}
              ...
              <div id="list_group4">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/list_group/love/section_title.jpg" alt="二人の恋　人気占い師6人がそれぞれ占う！　2022年あの人との恋愛成就鑑定"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
{if $list_love[0]}
                      <!-- パックメニュー個別リスト（一部無料なし） -->
