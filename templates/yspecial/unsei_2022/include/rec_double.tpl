...
{if $list_extra}
              ...
              <div class="rec_double" id="extra_group">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/rec_double/section_title.jpg" alt="まだまだあります！　今話題の人気占い師が占う　あなたの2022年の運勢"></h2>
...
{if $item_list.new && $isp == '70'}
                                    <img src="{$img_path}/img/special/rec_double/new.png" alt="" class="icon_new">
{/if}
                                    <div class="icon">
                                      <img src="{$img_path}/img/special/rec_double/banner/{$item_list.img_name}.jpg" alt="{$item_list.teller_name}" class="icon_category"><br>
                                    </div>
                                    <div class="menu_ttl">
...
{elseif $isp == '40'}
                                    <p class="price_info">{if $item_list.discount_flag == 1}<strong class="price_discount">プレミアム価格 {$item_list.menu_discount}円（税込）</strong>&nbsp;/&nbsp;通常価格 {/if}{$item_list.menu_price}円（税込）</p>
{else}
