...
{if $list_meet[0]}
              ...
              <div class="list_group meet">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/result/list_group/meet/section_title.jpg" alt="2022年あなたの恋愛運"></h2>
...
{* 通常用 *}
              ...
              <div id="list_group3">
                <div class="section_bdy">
                  <h2><img src="{$img_path}/img/special/list_group/meet/section_title.jpg" alt="恋愛運　「新たな出会いは訪れる？　今年は結婚できる？」2022年あなたの恋愛運"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
{if $list_meet[0]}
                      <!-- パックメニュー個別リスト（一部無料なし） -->
