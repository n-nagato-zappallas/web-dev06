...
{if $menu_design_cd == 99}
                  <div class="text_img">
                    <img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/pack_text1.jpg" alt="運勢グラフ付きで毎月の運勢もバッチリわかる！2022年あなたの総合運鑑定　超豪華パックはこちら">
                  </div>
{/if}
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/section_title.jpg" alt="6人全員の総合運鑑定がわかる豪華パック　パック限定特典として2022年の運気の流れがひと目で分かる！あなただけの運勢グラフ付き！　圧倒的な的中力の人気占い師6人があなたの2022年の運勢を完全鑑定！{if $isp == '70'}　それぞれ買うより5,900円以上もお得!※{elseif $isp == '40'}　それぞれ買うより5,900円以上もお得!!{else}　それぞれ買うより6,600円（税込）もお得※{/if}"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
                      
                      <!-- 6人パックメニュー -->
                      <div class="pack_menu">
                        <p><a href="{$uri_path}/input/nw22_003.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/btn.png" alt="人気占い師6人による豪華特別鑑定！「あなたの2022年運勢」豪華全網羅パック全78章" class="swapImage"></a></p>
{if $isp == '70'}
...
{elseif $isp == '40'}
                        <p class="price_info">プレミアム価格　<strong class="price_discount">5,940円（税込）</strong>&nbsp;/&nbsp;
