...
{if $menu_design_cd == 99}
                  <div class="text_img">
                    <img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/pack_text2.jpg" alt="相性グラフ付きで二人の毎月の運勢もバッチリわかる！　2022年あなたの恋運命鑑定　超豪華パックはこちら">
                  </div>
{/if}
                <div class="section_bdy">
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group2/section_title.jpg" alt="豪華恋愛鑑定パック　パック限定特典として絶好のタイミングがひと目で分かる！二人の相性グラフ付き！　最強の占い師6人が恋成就へ導く　2022年、恋愛鑑定の決定版！{if $isp == '70'}　それぞれ買うより5,900円以上もお得!※{elseif $isp == '40'}　それぞれ買うより5,900円以上もお得!{else}　それぞれ買うより6,600円（税込）もお得!※{/if}"></h2>
                  <div class="section_ftr">
                    <div class="section_hdr">
                      
                      <!-- 6人パックメニュー -->
                      <div class="pack_menu">
                        <p><a href="{$uri_path}/input/nw22_004.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group2/btn.png" alt="最強占い師6人が18,000字で紡ぐ二人の恋の行方「2022年あの人との恋」豪華恋愛特別鑑定パック" class="swapImage"></a></p>
{if $isp == '70'}
