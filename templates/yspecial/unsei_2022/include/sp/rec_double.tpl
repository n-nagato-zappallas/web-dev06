...
{if $list_extra}
              ...
              <div class="rec_double" id="extra_group">
                <div class="section_bdy">
                  <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/rec_double/section_title.jpg" alt="まだまだあります！　今話題の人気占い師が占う　あなたの2022年の運勢"></h3>
...
{elseif $isp == '40'}
                                <p class="price_info">{if $item_list.discount_flag == 1}<strong class="price_discount">プレミアム価格 {$item_list.menu_discount}円（税込）</strong><br>通常価格 {/if}{$item_list.menu_price}円（税込）</p>
{else}
