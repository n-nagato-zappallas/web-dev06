                        ...
                        <div class="basic_sub1">
                          <div class="section_bdy">
                            ...
                            <div class="section_ftr">
                              <div class="section_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/result/basic/star/hoshihitomi_zap/{$hoshihitomi_zap.base_id_other}.jpg" alt="運命数：{$hoshihitomi_zap.base_alt_other}">
...
{/section}
                      ...
                      <div class="message_group special">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/message_group/title_hoshihitomi_zap.jpg" alt="星ひとみからの成就メッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="menu_bdy">
                                <div class="menu_ftr">
...
{/section}
                      ...
                      <div class="message_group special">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/message_group/title_leon_rsa.jpg" alt="木下レオンからの成就メッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="menu_bdy">
                                <div class="menu_ftr">
...
{* 島田秀平（spshimada_zap） *}
                    <div class="menu_ttl_bar2 menu_ttl_{$spshimada_zap.menu_contents}" id="child_3">
                      <div class="menu_bdy">
                        <div class="menu_ftr">
                          <div class="menu_hdr">
                            <div class="severalmenu">
...
{/section}
                      ...
                      <div class="message_group special">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/message_group/title_spshimada_zap.jpg" alt="島田秀平からの成就メッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="menu_bdy">
                                <div class="menu_ftr">
...
{* 水晶玉子（suisho_zap） *}
                    <div class="menu_ttl_bar2 menu_ttl_{$suisho_zap.menu_contents}" id="child_4">
                      <div class="menu_bdy">
                        <div class="menu_ftr">
                          <div class="menu_hdr">
                            <div class="severalmenu">
...
{/section}
                      ...
                      <div class="message_group special">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/message_group/title_suisho_zap.jpg" alt="水晶玉子からの成就メッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="menu_bdy">
                                <div class="menu_ftr">
...
{* シウマ（shiuma2_zap） *}
                    <div class="menu_ttl_bar2 menu_ttl_{$shiuma2_zap.menu_contents}" id="child_5">
                      <div class="menu_bdy">
                        <div class="menu_ftr">
                          <div class="menu_hdr">
                            <div class="severalmenu">
...
{/section}
                      ...
                      <div class="message_group special">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/message_group/title_shiuma2_zap.jpg" alt="シウマからの成就メッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="menu_bdy">
                                <div class="menu_ftr">
...
{* 木村藤子（fujiko_ccs） *}
                    <div class="menu_ttl_bar2 menu_ttl_{$fujiko_ccs.menu_contents}" id="child_6">
                      <div class="menu_bdy">
                        <div class="menu_ftr">
                          <div class="menu_hdr">
                            <div class="severalmenu">
...
{/section}
                      ...
                      <div class="message_group special">
                        <div class="article_bdy">
                          <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/message_group/title_fujiko_ccs.jpg" alt="木村藤子からの成就メッセージ"></h3>
                          <div class="article_ftr">
                            <div class="article_hdr">
                              <div class="menu_bdy">
                                <div class="menu_ftr">
