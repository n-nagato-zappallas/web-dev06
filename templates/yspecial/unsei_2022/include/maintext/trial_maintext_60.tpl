                          ...
                          <div class="basic_sub1">
                            <div class="section_bdy">
                              ...
                              <div class="section_ftr">
                                <div class="section_hdr">
                                  <div class="severalmenu">
                                    <img src="{$img_path}/img/special/result/basic/star/hoshihitomi_zap/{$hoshihitomi_zap.base_id_other}.jpg" alt="運命数：{$hoshihitomi_zap.base_alt_other}">
...
{/section}
                        ...
                        <div class="message_group special">
                          <h3><img src="{$img_path}/img/special/result/message_group/title_hoshihitomi_zap.jpg" alt="星ひとみからの成就メッセージ"></h3>
...
{/section}
                        ...
                        <div class="message_group special">
                          <h3><img src="{$img_path}/img/special/result/message_group/title_leon_rsa.jpg" alt="木下レオンからの成就メッセージ"></h3>
                          <div class="article_bdy">
                            <div class="article_ftr">
                              <div class="article_hdr">
                                <div class="menu_bdy">
...
{/section}
                        ...
                        <div class="message_group special">
                          <h3><img src="{$img_path}/img/special/result/message_group/title_spshimada_zap.jpg" alt="島田秀平からの成就メッセージ"></h3>
                          <div class="article_bdy">
                            <div class="article_ftr">
                              <div class="article_hdr">
                                <div class="menu_bdy">
...
{/section}
                        ...
                        <div class="message_group special">
                          <h3><img src="{$img_path}/img/special/result/message_group/title_suisho_zap.jpg" alt="水晶玉子からの成就メッセージ"></h3>
                          <div class="article_bdy">
                            <div class="article_ftr">
                              <div class="article_hdr">
                                <div class="menu_bdy">
...
{/section}
                        ...
                        <div class="message_group special">
                          <h3><img src="{$img_path}/img/special/result/message_group/title_shiuma2_zap.jpg" alt="シウマからの成就メッセージ"></h3>
                          <div class="article_bdy">
                            <div class="article_ftr">
                              <div class="article_hdr">
                                <div class="menu_bdy">
...
{/section}
                        ...
                        <div class="message_group special">
                          <h3><img src="{$img_path}/img/special/result/message_group/title_fujiko_ccs.jpg" alt="木村藤子からの成就メッセージ"></h3>
                          <div class="article_bdy">
                            <div class="article_ftr">
                              <div class="article_hdr">
                                <div class="menu_bdy">
