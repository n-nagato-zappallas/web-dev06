...
{if $menu_person == '1'}
                    <h2 id="point_title2"><img src="{$img_path}/img/special/result/point_group/single/section_title.jpg" alt="2022年の運だめし！あなたの結果は……"></h2>
{else}
                    <h2 id="point_title2"><img src="{$img_path}/img/special/result/point_group/double/section_title.jpg" alt="2022年の二人の恋みくじ！気になるあの人との相性は……"></h2>
{/if}
...
{if $menu_person == '1'}
                          <h3><img src="{$img_path}/img/special/result/summary_group/single/menu_title.jpg" alt="6人がそれぞれちょっとずつ占います！　2022年あなたの運勢"></h3>
{else}
                          <h3><img src="{$img_path}/img/special/result/summary_group/double/menu_title.jpg" alt="6人がそれぞれちょっとずつ占います！　2022年のあの人との恋"></h3>
{/if}
