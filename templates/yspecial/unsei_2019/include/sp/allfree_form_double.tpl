              ...
              <div id="free_group2">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/group2/section_title.jpg" alt="超豪華恋愛無料鑑定　二人の相性は？　恋は進展する？　年内に結ばれる？　あなたとあの人の2019年の恋運勢"></h3>
                    <div class="section_ftr">
                      <div class="section_hdr">
                        ...
                        <input type="hidden" name="channel"  value="52h001">
                        <input type="hidden" name="event" value="{$event}">
                        <input type="hidden" name="menu_id" value="un2019_0002">
                              ...
                              <div class="menu_ftr">
                                <div class="menu_hdr">
                                  <div class="input_self">
                                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/title1.png" alt="あなたの情報を入力してください"></h3>
                                    <table class="input_tbl input_tbl_1" cellspacing="0">
                                      <tbody>
                                        <tr class="tr_name">
                                          <th><label for="name_self">お名前</label></th>
                                          <td>
                                            <input type="text" id="name_self2" name="name_self" size="36" maxlength="32" class="input_name">
                                          </td>
                                        </tr>
                                        <tr class="tr_caution">
                                          <td colspan="2">
                                        ...
                                        <tr class="tr_birthday">
                                          <th colspan="2"><label for="birth_year_self2">生年月日</label></th>
                                        </tr>
                                        <tr class="tr_birthday">
                                          <td colspan="2">
                                  ...
                                  <div class="input_other">
                                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/free_group/title2.png" alt="あの人の情報を入力してください"></h3>
                                    <table class="input_tbl input_tbl_1" cellspacing="0">
                                      <tbody>
                                        <tr class="tr_name">
                                          <th><label for="name_other">お名前</label></th>
                                          <td>
                                            <input type="text" id="name_other2" name="name_other" size="36" maxlength="32" class="input_name">
                                          </td>
                                        </tr>
                                        <tr class="tr_caution">
                                          <td colspan="2">
                                        ...
                                        <tr class="tr_birthday">
                                          <th colspan="2"><label for="birth_year_other2">生年月日</label></th>
                                        </tr>
                                        <tr class="tr_birthday">
                                          <td colspan="2">
                                    ...
                                    <div class="form_btn">
                                      <input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/free_group/free_button2.png" alt="2019年あの人との恋を無料で占う" id="free_button2" onclick="checkParams( this.form );" name="free_button2" class="swapImage">
                                    </div>
                                    <div class="privacy">
