...
{* 1人用パックメニューおすすめ枠（index、normal_allfree） *}
              <!-- 1人用パックメニュー -->
              <div id="pack_group1"{if $result_flag && $menu_person == '1'} class="result"{/if}>
                <div class="section_bdy">
{if !$result_flag || $result_flag && $menu_person == '2'}
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/section_title.jpg" alt="豪華パック総合運　さらに2019年の月運グラフ付きで毎月の運勢までズバリ！　圧倒的な的中力の人気占い師6人があなたの2019年の運勢を完全鑑定！　それぞれ買うより5,800円以上もお得！※"></h2>
{else}
                  <h2><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/section_title2.jpg" alt="運勢グラフで2019年の運勢もバッチリわかる！　全78章豪華2019年総合運パックはこちら　それぞれ買うより5,800円以上もお得！※"></h2>
{/if}
...
{if !$result_flag || $result_flag && $menu_person == '2'}
                        <p><a href="{$uri_path}/input/un2019_0003.html"><img width="100%" height="auto" src="{$img_path}/img_sp/special/pack_group/group1/button.png" alt="ここでしか占えない人気占い師6人が結集！「あなたの2019年運勢」豪華全方位パック全78章" class="swapImage"></a></p>
...
{/if}
                      ...
                      <p><input width="100%" height="auto" type="image" src="{$img_path}/img_sp/special/pack_group/group1/button.png" alt="ここでしか占えない人気占い師6人が結集！「あなたの2019年運勢」豪華全方位パック全78章" onclick="this.form.submit();" name="btn" class="swapImage"></p>
