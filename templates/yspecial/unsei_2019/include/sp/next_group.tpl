              ...
              <div id="next_group">
                <div class="balloon_group">
                  <div class="menu_bdy">
                    <div class="menu_hdr">
                      <div class="menu_ftr">
                        <p class="title_font">鑑定はいかがでしたか。あなたの2019年の運勢についてもっと詳しくお伝えしたいことがあります。ぜひご覧ください。</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div id="next_group1">
                  <div class="section_bdy">
                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/next_group/section_title1.jpg" alt="おすすめ2019年運勢メニュー1"></h3>
                            ...
                            <div class="menu_ftr">
                              <div class="menu_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/contents/photo/{$next_list[0].contents}.png" alt="">
                                  <h4>{$next_list[0].title}</h4>
                                  <div class="clear"></div>
                                </div>
                              </div>
                            </div>
...
{/section}
                ...
                <div id="next_group2">
                  <div class="section_bdy">
                    <h3><img width="100%" height="auto" src="{$img_path}/img_sp/special/result/next_group/section_title2.jpg" alt="おすすめ2019年運勢メニュー2"></h3>
                    <div class="section_hdr">
                      <div class="section_ftr">
                        <div class="menu_ttl_bar2 menu_ttl_{$next_list[1].contents}">
                          <div class="menu_bdy">
                            <div class="menu_ftr">
                              <div class="menu_hdr">
                                <div class="severalmenu">
                                  <img width="100%" height="auto" src="{$img_path}/img_sp/special/contents/photo/{$next_list[1].contents}.png" alt="">
                                  <h4>{$next_list[1].title}</h4>
                                  <div class="clear"></div>
                                </div>
                              </div>
                            </div>
