...
{* 島田秀平（spshimada_zap） *}
                      <h2 class="menu_ttl_bar {$spshimada_zap.menu_contents}" id="child_1"><img src="{$img_path}/img/special/title/{$menu_child_menu_id_1}.png" alt="{$spshimada_zap.menu_title}"></h2>
                      <!-- result_basic -->
...
{* 水晶玉子（suisho_zap） *}
                      <h2 class="menu_ttl_bar {$suisho_zap.menu_contents}" id="child_2"><img src="{$img_path}/img/special/title/{$menu_child_menu_id_2}.png" alt="{$suisho_zap.menu_title}"></h2>
                      <!-- result_basic -->
                      <div class="result_basic">
                        <div class="basic_self">
                          <div class="basic_sub1">
...
{* 御射山令元（zerogaku_zap） *}
                      <h2 class="menu_ttl_bar {$zerogaku_zap.menu_contents}" id="child_3"><img src="{$img_path}/img/special/title/{$menu_child_menu_id_3}.png" alt="{$zerogaku_zap.menu_title}"></h2>
                      <!-- result_basic -->
                      <div class="result_basic">
                        <div class="basic_self">
                          <div class="basic_sub1">
                            <div class="section_bdy">
                              ...
                              <div class="section_ftr">
                                <div class="section_hdr">
                                  <div class="severalmenu">
                                    <img src="{$img_path}/img/special/result/basic/star/zerogaku_zap/{$zerogaku_zap.base_id_self}.jpg" alt="{$zerogaku_zap.base_alt_self}">
                          ...
                          <div class="basic_sub1">
                            <div class="section_bdy">
                              ...
                              <div class="section_ftr">
                                <div class="section_hdr">
                                  <div class="severalmenu">
                                    <img src="{$img_path}/img/special/result/basic/star/zerogaku_zap/{$zerogaku_zap.base_id_other}.jpg" alt="{$zerogaku_zap.base_alt_other}">
...
{* 鏡リュウジ（complete_zap） *}
                      <h2 class="menu_ttl_bar {$complete_zap.menu_contents}" id="child_4"><img src="{$img_path}/img/special/title/{$menu_child_menu_id_4}.png" alt="{$complete_zap.menu_title}"></h2>
                      <!-- result_basic -->
                      <div class="result_basic">
                        <div class="basic_self">
                          <div class="basic_sub1">
                            <div class="section_bdy">
                              ...
                              <div class="section_ftr">
                                <div class="section_hdr">
                                  <div class="severalmenu">
                                    <img src="{$img_path}/img/special/result/basic/star/complete_zap/{$complete_zap.base_id_self}.jpg" alt="{$complete_zap.base_alt_self}">
                          ...
                          <div class="basic_sub1">
                            <div class="section_bdy">
                              ...
                              <div class="section_ftr">
                                <div class="section_hdr">
                                  <div class="severalmenu">
                                    <img src="{$img_path}/img/special/result/basic/star/complete_zap/{$complete_zap.base_id_other}.jpg" alt="{$complete_zap.base_alt_other}">
...
{* 細木数子（hosoki_ccs） *}
                      <h2 class="menu_ttl_bar {$hosoki_ccs.menu_contents}" id="child_5"><img src="{$img_path}/img/special/title/{$menu_child_menu_id_5}.png" alt="{$hosoki_ccs.menu_title}"></h2>
                      <!-- result_basic -->
                      <div class="result_basic">
                        <div class="basic_self">
                          <div class="basic_sub1">
                            <div class="section_bdy">
                              ...
                              <div class="section_ftr">
                                <div class="section_hdr">
                                  <div class="severalmenu">
                                    <img src="{$img_path}/img/special/result/basic/star/hosoki_ccs/{$hosoki_ccs.base_id_self}.jpg" alt="{$hosoki_ccs.base_alt_self}">
                          ...
                          <div class="basic_sub1">
                            <div class="section_bdy">
                              ...
                              <div class="section_ftr">
                                <div class="section_hdr">
                                  <div class="severalmenu">
                                    <img src="{$img_path}/img/special/result/basic/star/hosoki_ccs/{$hosoki_ccs.base_id_other}.jpg" alt="{$hosoki_ccs.base_alt_other}">
...
{* 木村藤子（fujiko_ccs） *}
                      <h2 class="menu_ttl_bar {$fujiko_ccs.menu_contents}" id="child_6"><img src="{$img_path}/img/special/title/{$menu_child_menu_id_6}.png" alt="{$fujiko_ccs.menu_title}"></h2>
                      <!-- result_basic -->
                      <div class="result_basic">
                        <div class="basic_self">
                          <div class="basic_sub1">
