...
{if !$result_flag || $result_flag && $menu_person == '1'}
                  <h2><img src="{$img_path}/img/special/pack_group/group2/section_title.jpg" alt="恋愛パック恋愛運　あなたとあの人の毎月の運勢が、グラフ付きでズバリ！　人気占い師6人が結集し二人の恋を徹底鑑定　2019年恋愛成就の決定版　それぞれ買うより5,800円以上もお得！※"></h2>
{else}
                  <h2><img src="{$img_path}/img/special/pack_group/group2/section_title2.jpg" alt="人気も的中力も最強占い師6人があの人との恋愛成就を強力鑑定　それぞれ買うより5,800円以上もお得！※"></h2>
{/if}
...
{if !$result_flag || $result_flag && $menu_person == '1'}
                        <p><a href="{$uri_path}/input/un2019_0004.html"><img src="{$img_path}/img/special/pack_group/group2/button.png" alt="超人気占い師6人による豪華恋鑑定　「2019年あの人との恋」　全恋運命特別鑑定パック" class="swapImage"></a></p>
...
{/if}
                        ...
                        <p><input type="image" src="{$img_path}/img/special/pack_group/group2/button.png" alt="超人気占い師6人による豪華恋鑑定　「2019年あの人との恋」　全恋運命特別鑑定パック" onclick="this.form.submit();" name="btn" class="swapImage"></p>
                        <p class="price_info">会員価格{literal}　<strong class="price_discount">{YJPRICE_5400}</strong>{/literal}&nbsp;/&nbsp;
                        通常価格{literal}　<strong class="price_discount">{YJPRICE_6000}</strong>{/literal}</p>
                        </form>
{* //完全無料二人用結果ページ用 *}
