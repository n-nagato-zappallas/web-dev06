              ...
              <div id="free_group1">
                ...
                <div id="free_group_form">
                  <div class="section_bdy">
                    <h2><img src="{$img_path}/img/special/free_group/group1/section_title.jpg" alt="超豪華無料鑑定　2019年の占い初め！　あなたの運勢を無料でズバリ鑑定！"></h2>
                    <div class="section_ftr">
                      <div class="section_hdr">
                        ...
                        <input type="hidden" name="channel"  value="52h000">
                        <input type="hidden" name="event" value="{$event}">
                        <input type="hidden" name="menu_id" value="un2019_0001">
                              ...
                              <div class="menu_bdy">
                                <div class="menu_ftr">
                                  <div class="menu_hdr">
                                    ...
                                    <div class="form_btn">
                                      <input type="image" src="{$img_path}/img/special/free_group/free_button.png" alt="2019年の運勢を無料で占う" id="free_button" onclick="checkParams( this.form );" name="free_button" class="swapImage">
                                    </div>
                                    <div class="privacy">
