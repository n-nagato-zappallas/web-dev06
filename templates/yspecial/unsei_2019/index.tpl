    ...
    <div id="index_base">
      <div id="base">
        <div id="index_basebdy">
          <div id="index_header">
            <h1><img src="{$img_path}/img/special/header_index2.jpg" alt="{$special_title}"></h1>
          </div>
...
{if $release_date >= '20190127'}
              ...
              <div id="new_group">
                <div class="banner_group" style="margin-top:20px;">
                  <p><a href="#month_group1"><img src="{$img_path}/img/special/new_group/banner5.png" alt="「ラッキーは訪れる？」　今月のあなたを待ち受ける運命は？『2019年5月のあなたの運勢』メニューを追加"></a></p>
<!--
                  <p><a href="#"><img src="{$img_path}/img/special/new_group/banner2.png" alt="「○○」メニューを更新"></a></p>
                  <p><a href="#"><img src="{$img_path}/img/special/new_group/banner2.png" alt="「○○」メニューを更新"></a></p>
-->
                </div>
              </div>
...
{/if}
              ...
              <div id="attention">
                  ...
                  <h3><img src="{$img_path}/img/special/attention.png" alt="注意事項"></h3>
