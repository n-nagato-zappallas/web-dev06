...
{if $menu_person == '1'}
                    ...
                    <h2 id="point_title"><img src="{$img_path}/img/special/result/point_group/single/section_title2.jpg" alt="2019年あなたの運勢"></h2>
{else}
                    <h2 id="point_title2"><img src="{$img_path}/img/special/result/point_group/double/section_title.jpg" alt=""></h2>
                    <h2 id="point_title"><img src="{$img_path}/img/special/result/point_group/double/section_title2.jpg" alt="2019年二人の相性"></h2>
{/if}
...
{if $menu_person == '1'}
                            <p id="item_1"><img src="{$img_path}/img/special/result/point_group/single/1.png" alt="仕事"></p>
                            <p id="item_2"><img src="{$img_path}/img/special/result/point_group/single/2.png" alt="恋愛"></p>
                            <p id="item_3"><img src="{$img_path}/img/special/result/point_group/single/3.png" alt="ご縁"></p>
                            <p id="item_4"><img src="{$img_path}/img/special/result/point_group/single/4.png" alt="旅行"></p>
                            <p id="item_5"><img src="{$img_path}/img/special/result/point_group/single/5.png" alt="結婚"></p>
                            <p id="item_6"><img src="{$img_path}/img/special/result/point_group/single/6.png" alt="収入"></p>
                            <p id="item_7"><img src="{$img_path}/img/special/result/point_group/single/7.png" alt="勝負"></p>
                            <p id="item_8"><img src="{$img_path}/img/special/result/point_group/single/8.png" alt="学問"></p>
{else}
                            <p id="item_1"><img src="{$img_path}/img/special/result/point_group/double/1.png" alt="価値観"></p>
                            <p id="item_2"><img src="{$img_path}/img/special/result/point_group/double/2.png" alt="尊敬"></p>
                            <p id="item_3"><img src="{$img_path}/img/special/result/point_group/double/3.png" alt="時間"></p>
                            <p id="item_4"><img src="{$img_path}/img/special/result/point_group/double/4.png" alt="結婚"></p>
                            <p id="item_5"><img src="{$img_path}/img/special/result/point_group/double/5.png" alt="安らぎ"></p>
                            <p id="item_6"><img src="{$img_path}/img/special/result/point_group/double/6.png" alt="信頼"></p>
                            <p id="item_7"><img src="{$img_path}/img/special/result/point_group/double/7.png" alt="趣味"></p>
                            <p id="item_8"><img src="{$img_path}/img/special/result/point_group/double/8.png" alt="欲望"></p>
{/if}
                          </div>
                          <div id="point_result">
                            <div class="menu_hdr">
                ...
                <div class="summary_group">
                  <div class="section_bdy">
{if $menu_person == '1'}
                    <h3><img src="{$img_path}/img/special/result/summary_group/title_single.jpg" alt="6人がそれぞれちょっとずつお見せします！　2019年あなたの運勢"></h3>
{else}
                    <h3><img src="{$img_path}/img/special/result/summary_group/title_double.jpg" alt="6人がそれぞれちょっとずつお見せします！　2019年の二人の恋"></h3>
{/if}
                    <div class="section_ftr">
                      <div class="section_hdr">
...
{/section}
                ...
                <div class="text_img">
{if $menu_person == '1'}
                  <img src="{$img_path}/img/special/pack_group/group1/text2.jpg" alt="運勢グラフで2019年の運勢もバッチリわかる！　全78章 豪華2019年総合運パックはこちら">
{else}
                  <img src="{$img_path}/img/special/pack_group/group2/text2.jpg" alt="運勢グラフで2019年の運勢もバッチリわかる！　78章 豪華2019年全恋運命特別鑑定パックはこちら">
{/if}
                </div>
