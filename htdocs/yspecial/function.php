...
// // define('SMARTY_DIR', 'Smarty/libs/'); //本番
...
// 		print_r('<pre>');print_r(__FUNCTION__);print_r('</pre>');exit;

// 		global $device_mode;

// 		$this->template_dir = SMARTY_TEMPLATE_DIR . $project_path;
// 		$this->compile_dir = SMARTY_TEMPLATE_C_DIR . $project_path;
...
class SmartyCommon2 extends Smarty {
    ...
    public function SmartyCommon2($project_path) {
        global $device_mode;
        $this->Smarty();
        $this->template_dir = SMARTY_TEMPLATE_DIR . $project_path;
...
// function convertEncoding( $key, $val ) {
// 	global $device_mode;
// 	if ($device_mode == "sp") {
// 		$str = $val;
// 	} else {
